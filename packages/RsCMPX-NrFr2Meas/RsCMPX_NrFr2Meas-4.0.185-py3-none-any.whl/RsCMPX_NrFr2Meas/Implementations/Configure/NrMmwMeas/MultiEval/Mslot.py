...
class MslotCls:
	...
	class MslotStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Meas_Slot_No: int: Slot number for MeasureSlot=UDEF The slot must be in the first radio frame (number of slots per subframe depends on SCS) . And the slot must be within the captured number of subframes, see [CMDLINK: CONFigure:NRMMw:MEASi:MEValuation:NSUBframes CMDLINK]."""
		__meta_args_list = [
