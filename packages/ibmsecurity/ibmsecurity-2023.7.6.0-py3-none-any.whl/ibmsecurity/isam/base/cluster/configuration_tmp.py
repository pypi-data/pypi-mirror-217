...
def _check(isamAppliance, cluster_json, ignore_password_for_idempotency):
   ...
   sorted_ret_obj = json.dumps(temp_retobj, skipkeys=True, sort_keys=True, cls=jsonSortedListEncoder)
   sorted_json_data = json.dumps(temp, skipkeys=True, sort_keys=True, cls=jsonSortedListEncoder)
