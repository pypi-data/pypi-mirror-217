...
class RoleApi(models.Model):
    ...
    description = models.CharField(verbose_name='API使用介绍', max_length=5000, blank=True, null=True, help_text='')
    created_time = models.DateTimeField(verbose_name='创建时间', auto_now=True, blank=True, null=True, help_text='')
