...
class RoleService:
    ...
    def add_role(params):
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=["role", "role_name", "parent_role_id|int", "user_group_id|int", "is_using|int", "description"]
        )
        if not params:
            return None, "参数不能为空"
        obj = Role(**params)
    ...
    def edit_role(params: dict = None):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "id|int", "role_id|int", "role", "role_key", "role_name", "parent_role_id|int", "user_group_id|int", "is_using|int", "description"
            ],
    ...
    @staticmethod
    def get_role_list(params: dict = None, need_pagination: bool = True, only_first: bool = False, filter_fields: bool = None, **kwargs):
        """
        查询角色列表,
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=[
                "role_id|int", "role", "user_group_id|int", "parent_role_id|int", "user_id|int",
    ...
    def user_bind_role(user_id, role_id: int = None, role_value: str = None):
        ...
        # 部门校验
        role_is_set = Role.objects.filter(role_id=role_id).first()
        if not role_is_set:
            return None, "该部门不存在"
