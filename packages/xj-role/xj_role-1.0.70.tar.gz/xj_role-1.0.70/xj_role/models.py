...
class RoleApi(models.Model):
    ...
    is_using = models.IntegerField(verbose_name='路由名称', default=1, choices=using_choices, blank=True, null=True, help_text='')
    description = models.CharField(verbose_name='路由使用介绍', max_length=5000, blank=True, null=True, help_text='')
    created_time = models.DateTimeField(Role, auto_now=True, blank=True, null=True, help_text='')
