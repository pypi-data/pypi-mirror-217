...
class RoleApiServices():
    ...
    def get_apis(params: dict = None, only_first: int = None, pagination=True, **kwargs):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=["route|str", "method|str", "name|str", "is_using|int", "is_open_api|int", ],
    ...
    def add_api(params: dict = None, **kwargs):
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=["route|str", "method|str", "name|str", "is_using|int", "is_open_api|int", "description|str"]
        )
