...
def percentage(num=None, perc=None):
    ...
    if choice == 1:
        ...
        print(str(perc) + "% of " + str(num) + " is " + str((perc / 100) * num))
    elif choice == 2:
        if num is None:
            num = float(input("Enter the number: "))
        elif perc is None:
            perc = float(input("Enter the percentage: "))
        print(str(num) + " increased by " + str(perc) + "% is " + str(num + ((perc / 100) * num)))
    elif choice == 3:
        if num is None:
            num = float(input("Enter the number: "))
        elif perc is None:
            perc = float(input("Enter the percentage: "))
        print(str(num) + " decreased by " + str(perc) + "% is " + str(num - ((perc / 100) * num)))
    elif choice == 4:
        sys.exit()
    else:
        print("Invalid choice!")
