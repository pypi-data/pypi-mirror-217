...
class ExternalTables(Generic[ExternalTableT], ReprJsonable):
    ...
    _create_table: Optional[Callable[[ExternalTableIdentifier], ExternalTableT]]
    ...
    def __getitem__(self, table_key: ExternalTableKey, /) -> ExternalTableT:
        ...
        table: ExternalTableT = self._create_table(identifier)
        return table
    ...
    def _from_list(
        ...
        database_key: str,
        *,
        create_table_method: Callable[[ExternalTableIdentifier], ExternalTableT],
    ) -> ExternalTables[ExternalTableT]:
