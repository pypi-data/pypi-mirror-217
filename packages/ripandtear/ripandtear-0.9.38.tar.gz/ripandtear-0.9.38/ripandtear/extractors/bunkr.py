...
class Bunkr(Common):
    ...
    async def single(self, url_dictionary: UrlDictionary) -> None:
        ...
        try:
            ...
            elif re_bunkr_single.match(url_dictionary['url']).group(2) is not None and re_bunkr_image_prefix.match(re_bunkr_single.match(url_dictionary['url']).group(2)):

                if re_bunkr_single.match(url_dictionary['url']).group(9) is not None and re_bunkr_video_extensions.match(re_bunkr_single.match(url_dictionary['url']).group(9)):
