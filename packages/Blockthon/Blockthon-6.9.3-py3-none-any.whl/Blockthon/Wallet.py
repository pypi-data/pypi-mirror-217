...
from Blockthon.Utils import HexToBTC
...
Convert Private Key HEX To `P2PKH` Bitcoin Address.
       ...
       >>> p2pkh_address = HexToBTC(privatekey, 'P2PKH')
...
Convert Private Key HEX To `P2SH` Bitcoin Address.
    ...
    >>> p2sh_address = HexToBTC(privatekey, 'P2SH')
...
Convert Private Key HEX To `P2WPKH` Bitcoin Address.
    ...
    >>> p2wpkh_address = HexToBTC(privatekey, 'P2WPKH')
...
Convert Private Key HEX To `P2WSH` Bitcoin Address.
    ...
    >>> p2wsh_address = HexToBTC(privatekey, 'P2WSH')
...
Convert Private Key HEX To `P2WPKH in Segwit` Bitcoin Address.
    ...
    >>> p2wpkhSegwit_address = HexToBTC(privatekey, 'P2WPKHinP2SH')
...
Convert Private Key HEX To `P2WSH in Segwit` Bitcoin Address.
    ...
    >>> p2wshSegwit_address = HexToBTC(privatekey, 'P2WSHinP2SH')
...
def Dec_To_Address(dec: int, compress: bool = False) -> str:
    """ Convert Number Dec To Compress and UnCompress Address """
    byte_dec = DecToBytes(dec)
    if compress:
        return BytesToAddr(byte_dec, compress=True)
    else:
        return BytesToAddr(byte_dec, compress=False)
