...
def build_sparse_pre_annotation_with_interpolated() -> OLM.OpenLabelAnnotation:
    ...
    return OLM.OpenLabelAnnotation(
        openlabel=OLM.Openlabel(
            ...
            frames={
                "0": build_frame(0, object_uuid, build_frame_object_interpolated(0, False, "Empire", "Medium")),
                "1": build_frame(100, object_uuid, build_frame_object_interpolated(5, True, "Empire", "Light")),
                "2": build_frame(200, object_uuid, build_frame_object_interpolated(10, True, "Rebels", "Light")),
                "3": build_frame(300, object_uuid, build_frame_object_interpolated(5, False, "Rebels", "Light")),
            },
...
def build_sparse_pre_annotation_with_od_pointers() -> OLM.OpenLabelAnnotation:
    ...
    root_object = OLM.Object(name="MyNameIsBox", type="SpaceShip", object_data_pointers=od_pointers)
    ...
    return OLM.OpenLabelAnnotation(
        openlabel=OLM.Openlabel(
            ...
            frames={
                "0": build_frame(0, object_uuid, build_frame_object_od_pointer(0, False, "Empire", "Medium")),
                "1": build_frame(100, object_uuid, build_frame_object_od_pointer(5, True, "Empire", "Light")),
                "2": build_frame(200, object_uuid, build_frame_object_od_pointer(10, True, "Rebels", "Light")),
                "3": build_frame(300, object_uuid, build_frame_object_od_pointer(5, False, "Rebels", "Light")),
            },
            frame_intervals=[OLM.FrameInterval(frame_start=0, frame_end=2)],
            streams={LIDAR1: OLM.Stream(type=OLM.StreamTypes.lidar), CAMERA1: OLM.Stream(type=OLM.StreamTypes.camera)},
        )
...
def build_frame_object_interpolated(offset: int, interpolated: bool, faction: str, occlusion: str) -> OLM.Objects:
    return OLM.Objects(
        object_data=OLM.ObjectData(
            text=[OLM.Text(name="faction", val=faction)],
...
def build_frame_object_od_pointer(offset: int, interpolated: bool, faction: str, occlusion: str) -> OLM.Objects:
    return OLM.Objects(
        object_data=OLM.ObjectData(
            text=[OLM.Text(name="faction", val=faction)],
