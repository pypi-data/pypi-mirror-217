...
def test_resource_id_or_path_image_without_resource_id():
    image_dict = Image(filename="path/to/foo.jpg", resource_id=None, sensor_name="not used").to_dict()
    assert image_dict['resourceId'] == "path/to/foo.jpg"


def test_resource_id_or_path_image_with_resource_id():
    image_dict = Image(filename="path/to/foo.jpg", resource_id="local://foo/bar", sensor_name="not used").to_dict()
