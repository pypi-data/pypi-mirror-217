...
from boaviztapi_sdk.api.utils_api import UtilsApi  # noqa: E501
...
class TestUtilsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = boaviztapi_sdk.api.utils_api.UtilsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_name_to_cpu_v1_utils_name_to_cpu_get(self):
    ...
    def test_utils_get_all_case_type_v1_utils_case_type_get(self):
    ...
    def test_utils_get_all_countries_v1_utils_country_code_get(self):
    ...
    def test_utils_get_all_cpu_family_v1_utils_cpu_family_get(self):
    ...
    def test_utils_get_all_cpu_model_range_v1_utils_cpu_model_range_get(self):
    ...
    def test_utils_get_all_cpu_name_v1_utils_cpu_name_get(self):
    ...
    def test_utils_get_all_impacts_criteria_v1_utils_impact_criteria_get(self):
    ...
    def test_utils_get_all_ram_manufacturer_v1_utils_ram_manufacturer_get(self):
    ...
    def test_utils_get_all_ssd_manufacturer_v1_utils_ssd_manufacturer_get(self):
