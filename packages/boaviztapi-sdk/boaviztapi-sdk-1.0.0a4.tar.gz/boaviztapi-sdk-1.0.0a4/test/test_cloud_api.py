...
class TestCloudApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = boaviztapi_sdk.api.cloud_api.CloudApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_get_archetype_config_v1_cloud_instance_instance_config_get(self):
    ...
    def test_instance_cloud_impact_v1_cloud_instance_get(self):
    ...
    def test_instance_cloud_impact_v1_cloud_instance_post(self):
    ...
    def test_server_get_all_archetype_name_v1_cloud_instance_all_instances_get(self):
    ...
    def test_server_get_all_provider_name_v1_cloud_instance_all_providers_get(self):
