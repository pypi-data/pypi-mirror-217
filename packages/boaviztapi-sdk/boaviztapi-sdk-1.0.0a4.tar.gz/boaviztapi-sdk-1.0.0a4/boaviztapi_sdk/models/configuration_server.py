...
class ConfigurationServer(BaseModel):
    ...
    ram: Optional[conlist(RAM)] = None
    disk: Optional[conlist(Disk)] = None
    power_supply: Optional[PowerSupply] = None
    __properties = ["cpu", "ram", "disk", "power_supply"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationServer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationServer:
        """Create an instance of ConfigurationServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationServer.parse_obj(obj)

        _obj = ConfigurationServer.parse_obj({
