...
class ConsumptionProfileCPU(BaseModel):
    ...
    """
    workload: Optional[conlist(WorkloadPower)] = None
    cpu: Optional[CPU] = None
    __properties = ["workload", "cpu"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConsumptionProfileCPU:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConsumptionProfileCPU:
        """Create an instance of ConsumptionProfileCPU from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsumptionProfileCPU.parse_obj(obj)

        _obj = ConsumptionProfileCPU.parse_obj({
