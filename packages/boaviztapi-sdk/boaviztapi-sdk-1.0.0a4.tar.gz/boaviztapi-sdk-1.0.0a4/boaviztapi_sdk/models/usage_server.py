...
class UsageServer(BaseModel):
    ...
    __properties = ["use_time_ratio", "hours_life_time", "avg_power", "time_workload", "usage_location", "elec_factors", "other_consumption_ratio"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageServer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageServer:
        """Create an instance of UsageServer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageServer.parse_obj(obj)

        _obj = UsageServer.parse_obj({
