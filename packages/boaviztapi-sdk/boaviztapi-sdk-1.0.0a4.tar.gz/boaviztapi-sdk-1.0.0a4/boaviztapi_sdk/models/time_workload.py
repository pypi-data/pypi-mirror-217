...
class TimeWorkload(BaseModel):
    ...
    anyof_schema_2_validator: Optional[conlist(WorkloadTime)] = None
    actual_instance: Any
    any_of_schemas: List[str] = Field(TIMEWORKLOAD_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = TimeWorkload.construct()
        error_messages = []
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeWorkload:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> TimeWorkload:
