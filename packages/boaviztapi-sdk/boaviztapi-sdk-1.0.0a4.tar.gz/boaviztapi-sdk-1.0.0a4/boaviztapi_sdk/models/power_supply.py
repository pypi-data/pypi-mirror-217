...
from boaviztapi_sdk.models.usage1 import Usage1
...
class PowerSupply(BaseModel):
    ...
    __properties = ["units", "usage", "unit_weight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PowerSupply:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PowerSupply:
        """Create an instance of PowerSupply from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PowerSupply.parse_obj(obj)

        _obj = PowerSupply.parse_obj({
            "units": obj.get("units"),
            "usage": Usage1.from_dict(obj.get("usage")) if obj.get("usage") is not None else None,
