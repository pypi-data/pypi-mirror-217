...
class Usage1(BaseModel):
    ...
    __properties = ["use_time_ratio", "hours_life_time", "avg_power", "time_workload", "usage_location", "elec_factors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Usage1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Usage1:
        """Create an instance of Usage1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Usage1.parse_obj(obj)

        _obj = Usage1.parse_obj({
