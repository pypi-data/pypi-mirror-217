...
class WorkloadTime(BaseModel):
    ...
    __properties = ["time_percentage", "load_percentage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadTime:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadTime:
        """Create an instance of WorkloadTime from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadTime.parse_obj(obj)

        _obj = WorkloadTime.parse_obj({
