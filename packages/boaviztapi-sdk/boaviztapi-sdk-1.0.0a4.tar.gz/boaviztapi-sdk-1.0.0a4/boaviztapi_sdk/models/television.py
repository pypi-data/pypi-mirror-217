...
class Television(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Television:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Television:
        """Create an instance of Television from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Television.parse_obj(obj)

        _obj = Television.parse_obj({
