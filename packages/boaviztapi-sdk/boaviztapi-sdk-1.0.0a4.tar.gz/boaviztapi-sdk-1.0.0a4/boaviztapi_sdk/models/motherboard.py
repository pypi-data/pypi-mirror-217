...
class Motherboard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Motherboard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Motherboard:
        """Create an instance of Motherboard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Motherboard.parse_obj(obj)

        _obj = Motherboard.parse_obj({
            "units": obj.get("units"),
