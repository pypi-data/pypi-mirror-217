...
class RAM(BaseModel):
    ...
    __properties = ["units", "usage", "capacity", "density", "process", "manufacturer", "model"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RAM:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RAM:
        """Create an instance of RAM from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RAM.parse_obj(obj)
