...
class UsageCloud(BaseModel):
    ...
    __properties = ["use_time_ratio", "hours_life_time", "avg_power", "time_workload", "usage_location", "elec_factors", "other_consumption_ratio", "instance_per_server"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsageCloud:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsageCloud:
        """Create an instance of UsageCloud from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsageCloud.parse_obj(obj)

        _obj = UsageCloud.parse_obj({
