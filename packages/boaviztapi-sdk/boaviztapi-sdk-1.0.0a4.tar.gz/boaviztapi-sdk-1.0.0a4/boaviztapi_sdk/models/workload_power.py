...
class WorkloadPower(BaseModel):
    ...
    __properties = ["load_percentage", "power_watt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkloadPower:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkloadPower:
        """Create an instance of WorkloadPower from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkloadPower.parse_obj(obj)

        _obj = WorkloadPower.parse_obj({
