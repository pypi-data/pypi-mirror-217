...
class ElecFactors(BaseModel):
    ...
    __properties = ["gwp", "adp", "pe", "gwppb", "gwppf", "gwpplu", "ir", "lu", "odp", "pm", "pocp", "wu", "mips", "adpe", "adpf", "ap", "ctue", "ctuh_c", "ctuh_nc", "epf", "epm", "ept"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ElecFactors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ElecFactors:
        """Create an instance of ElecFactors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ElecFactors.parse_obj(obj)

        _obj = ElecFactors.parse_obj({
            "gwp": obj.get("gwp"),
            "adp": obj.get("adp"),
            "pe": obj.get("pe"),
            "gwppb": obj.get("gwppb"),
