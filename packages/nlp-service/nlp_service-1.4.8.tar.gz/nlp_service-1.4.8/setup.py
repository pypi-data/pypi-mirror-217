...
install_requires = \
['arg-services>=1.4.0,<2.0.0',
 'mashumaro>=3.8.1,<4.0.0',
 'nltk>=3.8.1,<4.0.0',
...
extras_require = \
{'all': ['gensim>=4.3.1,<5.0.0',
         'python-Levenshtein>=0.21.1,<0.22.0',
         'sentence-transformers>=2.2.2,<3.0.0',
         'torch>=2.0.0,!=2.0.1,<3.0',
         'transformers>=4.30.2,<5.0.0',
         'openai>=0.27.8,<0.28.0'],
 'levenshtein': ['python-Levenshtein>=0.21.1,<0.22.0'],
 'openai': ['openai>=0.27.8,<0.28.0'],
 'sentence-transformers': ['sentence-transformers>=2.2.2,<3.0.0',
                           'torch>=2.0.0,!=2.0.1,<3.0'],
 'transformers': ['torch>=2.0.0,!=2.0.1,<3.0', 'transformers>=4.30.2,<5.0.0'],
