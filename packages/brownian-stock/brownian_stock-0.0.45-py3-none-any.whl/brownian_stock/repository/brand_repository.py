...
class BrandRepository:
    ...
    def load(self) -> List[Brand]:
        ...
        for _, row in brand_df.iterrows():
            ...
            brand = Brand(code=code, company_name=company_name, company_name_english=company_name_english,
                          sector17=sector17, sector33=sector33, scale_category=scale_category,
                          market_code=market_code, margin_code=margin_code)
