...
class Uberduck:
    ...
    def get_voices(
        ...
        *,
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", "voices"),
            params={
                "mode": mode,
                "language": language,
    ...
    def get_voice_detail(self, voicemodel_uuid: str) -> VoiceReturn:
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", f"voices/{voicemodel_uuid}/detail"),
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
            timeout=60,
    ...
    def fetch_voice_samples(self, voicemodel_uuid: str) -> typing.List[Sample]:
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", f"voices/{voicemodel_uuid}/samples"),
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
            timeout=60,
    ...
    def generate_lyrics(
        ...
        *,
        ...
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "tts/lyrics"),
    ...
    def generate_freestyle(
        ...
        *,
        ...
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "tts/freestyle"),
            json=jsonable_encoder(_request),
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
    ...
    def do_voice_to_voice_conversion(
        ...
        *,
        ...
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "tts/convert"),
            json=jsonable_encoder(_request),
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
    ...
    def train(
        ...
        *,
        ...
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "train"),
            json=jsonable_encoder(_request),
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
    ...
    def get_speak_status(self, *, uuid: str) -> SpeakStatusResponse:
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", "speak-status"),
            params={"uuid": uuid},
            headers=remove_none_from_headers(
                {"Authorization": f"Bearer {self._token}" if self._token is not None else None}
            ),
    ...
    def generate_speech(self, *, request: TtsRequest, uberduck_id: typing.Optional[str] = None) -> Uuid:
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "speak"),
    ...
    def generate_speech_synchronously(self, *, request: TtsRequest, uberduck_id: typing.Optional[str] = None) -> None:
        _response = httpx.request(
            "POST",
            urllib.parse.urljoin(f"{self._environment}/", "speak-synchronous"),
            json=jsonable_encoder(request),
            headers=remove_none_from_headers(
                {
                    "uberduck-id": uberduck_id,
    ...
    def get_voice_stats(
        ...
        *,
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", "voice-stats"),
    ...
    def get_voice_data(
        ...
        *,
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", "voice-data"),
    ...
    def convert_english_to_ipa_phonemes(
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment}/", "g2p"),
