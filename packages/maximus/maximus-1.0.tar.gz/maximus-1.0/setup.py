...
setup(
    name="maximus",
    packages=["maximus", "maximus.lib", "maximus.containers"],
    version="1.0",
    license="MIT",
    ...
    url="https://github.com/ekosijabat/maximus",
    download_url="https://github.com/ekosijabat/maximus/archive/refs/tags/v1.0.tar.gz",
