...
def main():
    ...
    parser.add_mutually_exclusive_group("-h","--help",help="帮助")
    parser.add_mutually_exclusive_group("-u", "--update-api-token", help="设置/更新个人的API-token")
    parser.add_mutually_exclusive_group("-c", "--category", help="查看分类体系中的编码与含义",default=None)
