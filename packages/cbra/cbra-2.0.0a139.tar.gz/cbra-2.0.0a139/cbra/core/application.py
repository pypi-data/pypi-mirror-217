...
class Application(FastAPI, EndpointProvider):
    ...
    teardown_handlers: set[Callable[..., Awaitable[Any]]] = set()
    ...
    def __init__(self, **kwargs: Any):
        ...
        FastAPI.__init__(self, lifespan=self.lifespan_handler, **kwargs)
    ...
    async def run(
        ...
        **kwargs: Any
        ...
        async with self.lifespan_handler(self):
            return await run(f, container=self.container, scope={'app': self}, **kwargs)
