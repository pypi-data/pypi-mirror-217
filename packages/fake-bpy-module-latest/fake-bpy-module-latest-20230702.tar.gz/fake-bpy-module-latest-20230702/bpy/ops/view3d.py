...
def edit_mesh_extrude_manifold_normal(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude manifold region along normals :File: `startup/bl_operators/view3d.py\:181 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L181>`__
...
def edit_mesh_extrude_move_shrink_fatten(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Extrude region together along local normals :File: `startup/bl_operators/view3d.py\:164 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L164>`__
...
def transform_gizmo_set(override_context: typing.
    ...
    ''' Set the current transform gizmo :File: `startup/bl_operators/view3d.py\:224 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L224>`__
