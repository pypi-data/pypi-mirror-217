...
def test_with_no_parameters() -> None:
    ...
    expected_output = ""
    expected_error = """usage: cookieslicer [-f] [-g] [-l] [-i INPUT_DIRECTORY] -s SOURCE_DIRECTORY -p
                    PROJECT_NAME [-o OUTPUT_DIRECTORY] [--stack-trace] [-h]
...
def test_with_help_parameter() -> None:
    ...
    expected_output = """usage: cookieslicer [-f] [-g] [-l] [-i INPUT_DIRECTORY] -s SOURCE_DIRECTORY -p
                    PROJECT_NAME [-o OUTPUT_DIRECTORY] [--stack-trace] [-h]
