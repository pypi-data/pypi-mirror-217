...
from IAMPASS.status import Status
...
class Session:
    """
        ...
        Attributes:
            ...
            session_secret (str): Secret used to authenticate REST calls to IAMPASS service.
    ...
    def from_authentication_response(session_data: dict):
        """
            ...
            Parameters:
                session_data (dict): The data returned from a call to the IAMPASS authenticate_user API.
        """
    ...
    def get_status(self ):
        """
            ...
            Calls the IAMPASS service to get the status of the session.
    ...
    def destroy(self):
        """
            ...
            Calls the IAMPASS service to terminate this session.
