...
set_target_properties(pinocchio::pinocchio_pywrap_default PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap_default.cpython-311-x86_64-linux-gnu.so.2.9.2"
  IMPORTED_SONAME_RELEASE "pinocchio_pywrap_default.cpython-311-x86_64-linux-gnu.so.2.9.2"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_default )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_default "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap_default.cpython-311-x86_64-linux-gnu.so.2.9.2" )
...
set_target_properties(pinocchio::pinocchio_pywrap_casadi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap_casadi.cpython-311-x86_64-linux-gnu.so.2.9.2"
  IMPORTED_SONAME_RELEASE "pinocchio_pywrap_casadi.cpython-311-x86_64-linux-gnu.so.2.9.2"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_casadi )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_casadi "${PACKAGE_PREFIX_DIR}/lib/python3.11/site-packages/pinocchio/pinocchio_pywrap_casadi.cpython-311-x86_64-linux-gnu.so.2.9.2" )
