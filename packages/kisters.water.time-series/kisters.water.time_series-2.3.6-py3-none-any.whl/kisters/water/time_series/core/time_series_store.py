...
class TimeSeriesStore:
    ...
    def get_by_filter(
        ...
        **kwargs: Any,
        ...
        return (ts for ts_iter in time_series for ts in ts_iter)
    ...
    def create_time_series(
        ...
        **kwargs: Any,
        ...
        """
        return self.client.run_sync(self.client.create_time_series, path=path, metadata=metadata, **kwargs)
