...
class LinkResponse(pydantic.BaseModel):
    ...
    provider: Provider = pydantic.Field(
        description=(
            "The provider that most recently facilitated the creation of this link.  Note that\n"
            "        MoneyKit may switch providers if necessary to provide continuous access to the institution.\n"
        )
    )
    webhook: typing.Optional[str] = pydantic.Field(description=("The webhook url assigned to this link.\n"))
