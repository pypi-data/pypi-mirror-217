...
long_description = """
Source code: https://github.com/chenyk1990/pyint""".strip() 
...
nprec3d_module = Extension('npre3dcfun', sources=['pyint/src/npre3d.c','pyint/src/npre_alloc.c'])
...
setup(
    ...
    author="pyint developing team",
    author_email="chenyk2016@gmail.com",
    url="https://github.com/chenyk1990/pyint",
