...
def adapt_pymca_config_energy(
    cfg: ConfigDict, energy0: Optional[float], energy0_multiplier: float
):
    ...
    if new_cfg["energy"][-1] < energy0 * energy0_multiplier:
...
def adapt_pymca_config(
    ...
    Args:
        ...
        energy_multiplier(Optional(num)): add high primary energy with given multiplier with very low weight
