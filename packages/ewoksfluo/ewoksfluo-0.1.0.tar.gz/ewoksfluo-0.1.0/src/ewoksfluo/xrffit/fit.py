...
def perform_batch_fit(
    ...
    :param energy_multiplier: adds a higher energy bound equal to energy*energy_multiplier to include high-energy peaks. Defaults to 0.
...
def _parse_hdf5_uris(
    ...
    split_results = list(zip(*(filename.split("::") for filename in uris)))
