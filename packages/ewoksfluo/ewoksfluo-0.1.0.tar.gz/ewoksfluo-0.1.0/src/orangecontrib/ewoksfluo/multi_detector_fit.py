...
from ewoksfluo.tasks.multi_detector_fit import MultiDetectorFit
from ewoksfluo.gui.data_viewer import DataViewer


__all__ = ["OWMultiDetectorFit"]


class OWMultiDetectorFit(
    OWEwoksWidgetOneThread, **ow_build_opts, ewokstaskclass=MultiDetectorFit
):
    name = "Multi-Detector Fit"
    ...
    def _get_output_filename(self):
        uri = self.get_task_input_value("output_uri_template")
        if not uri:
            return None
