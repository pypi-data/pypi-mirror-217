...
class OWRegridStack(
    ...
    def _init_control_area(self):
        ...
        parameters = {
            ...
            "position1_suburi": {
                "label": "URI with respect to scan URIs of the position 1 dataset",
                "value_for_type": "",
            },
            "position2_suburi": {
                "label": "URI with respect to scan URIs of the position 2 dataset",
                "value_for_type": "",
            },
            "scan_variable_suburi": {
                "label": "URI with respect to scan URIs of the parameter that varies with scans",
                "value_for_type": "",
            },
        }
