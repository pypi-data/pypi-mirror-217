...
@decorator
def diskcache(func, location='cachedir', ttl=None, ignore=None, verbose=1, *args, **kwargs):
    """
    ...
    args = filter_args(func, ignore or [], list(args), kwargs)
    key = hashing.hash(args)
    ...
    return _ if not inspect.isgeneratorfunction(func) else iter(_)
