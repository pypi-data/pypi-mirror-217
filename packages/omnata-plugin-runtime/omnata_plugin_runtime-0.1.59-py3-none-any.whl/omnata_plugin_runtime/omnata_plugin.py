...
from .configuration import STANDARD_OUTBOUND_SYNC_ACTIONS, OutboundSyncAction, OutboundSyncStrategy, OutboundSyncConfigurationParameters, InboundSyncConfigurationParameters, ConnectionConfigurationParameters, StoredConfigurationValue, StoredMappingValue, StreamConfiguration, SubscriptableBaseModel, SyncConfigurationParameters, StoredStreamConfiguration
...
class OmnataPlugin(ABC):
    ...
    def outbound_record_validator(self,sync_parameters:Dict[str, StoredConfigurationValue],
                            field_mappings:StoredMappingValue,
                            transformed_record:Dict[str,Any],
                            source_types:Dict[str,str]) -> Optional[Dict[str,str]]:
        """
