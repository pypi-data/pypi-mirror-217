...
FormFieldBase = Annotated[Union[FormInputField,FormTextAreaField,FormSshKeypair,FormGpgKeypair,FormRadioField,FormCheckboxField,FormSliderField,FormDropdownField], Field(discriminator='type')]
