...
def split_into_new_tabs_of_single_report(input_report_path, column_number_to_split_by):
...
def split_into_separate_reports(input_report_path, column_number_to_split_by):
