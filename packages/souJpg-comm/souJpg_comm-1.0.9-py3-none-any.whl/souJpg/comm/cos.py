...
class CosOps(object):
    def __init__(self):
        secret_id = "AKIDUt79wVs34vmU0N4YpvqY3KOGvLXYM1Ve"  # 替换为用户的 SecretId，请登录访问管理控制台进行查看和管理，https://console.cloud.tencent.com/cam/capi
        secret_key = "1rW0HMEtNejbHl12rW0KYcP0NZgcKo59"  # 替换为用户的 SecretKey，请登录访问管理控制台进行查看和管理，https://console.cloud.tencent.com/cam/capi
