...
class MmObjectDetectionDataset(RuntimeDetectionDatasetAdapter):
    ...
    def __getitem__(self, index: int) -> Union[Dict[str, Any], None]:
        ...
        gtlabels_padded = torch.tensor([-1] * self.maximum_no_labels_per_image)
        gtlabels_padded[:len(gtlabels)] = gtlabels
        ...
        example = {
            ...
            MmDetectionDatasetLiterals.GT_LABELS: gtlabels_padded,
