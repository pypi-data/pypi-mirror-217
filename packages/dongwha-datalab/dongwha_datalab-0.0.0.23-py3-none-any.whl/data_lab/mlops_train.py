...
class mlops():
    ...
    G_TRIAN_CONTAINER_LIST = ['autogluon', 'scikit-learn']
    G_TRANSFORM_CONTAINER_LIST = ['scikit-learn','autogluon']
    ...
    def __init__(self, environment, aws_access_key_id = None, aws_secret_access_key = None): 
        pn.extension()
    ...
    #             collection.update_one({'model_id' : model_id, 'script_ver' : script_ver}, {'$set' : {'endp_name' : insert_info['endp_name'] , 'endp_config_mode' : insert_info['endp_config_mode'], 'max_concurrency' : insert_info['max_concurrency'], 'mem_size' : insert_info['mem_size'], 'init' : insert_info['init']} } )
            ...
            return {'msg' : "sagemaker로 해당 파일을 전송했습니다.", 'status' : 'success' } 
    ...
    def main_display_config(self) : 
        ...
        if self.G_FILE_EDITOR == 'PANEL' : 
            self.P_EXTRACT_FILE_PATH   = pn.widgets.FileSelector(r'C:\Users\dongwha\Downloads\v113\밀도')
            self.P_TRANSFORM_FILE_PATH = pn.widgets.FileSelector(r'C:\Users\dongwha\Downloads\v113\밀도')
            self.P_TRAIN_FILE_PATH     = pn.widgets.FileSelector(r'C:\Users\dongwha\Downloads\v113\밀도')
            self.P_ENDPOINT_FILE_PATH  = pn.widgets.FileSelector(r'C:\Users\dongwha\Downloads\v113\밀도')
        else : 
    ...
    def main_display(self) :
        def d(event):
            ...
            try : 
                ...
                chk_upload_s3_ml_script = ('[문법에러 추정] : ' + ste(e), 'danger')
        ...
        display( pn.Row( self.P_TRIAN_CONTAINER, self.P_TRANSFORM_CONTAINER ) ) 
