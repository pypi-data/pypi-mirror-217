...
import narwhalyeti
from narwhalyeti.models.task_duplicate_request import TaskDuplicateRequest  # noqa: E501
...
class TestTaskDuplicateRequest(unittest.TestCase):
    ...
    def testTaskDuplicateRequest(self):
        ...
        # model = narwhalyeti.models.task_duplicate_request.TaskDuplicateRequest()  # noqa: E501
        pass
