...
def run():
    ...
    print('###############################')
    print(f"Dumping assets located in {arguments.path}...")
    print(f"Logging level {arguments.logging_level}")
    print(f"Output file {arguments.output_file_path}")
    print('###############################')
    ...
    # with arguments.output_file_path.open('w') as fd:
