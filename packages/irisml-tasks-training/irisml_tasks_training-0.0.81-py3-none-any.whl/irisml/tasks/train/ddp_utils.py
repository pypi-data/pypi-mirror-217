...
def create_distributed_data_parallel_model(model, device_ids):
    # We might need to enable find_unused_parameters feature in the future.
...
def recreate_distributed_data_parallel_model(ddp_model, device_ids):
    model = ddp_model.module._model
    return create_distributed_data_parallel_model(model, device_ids)
