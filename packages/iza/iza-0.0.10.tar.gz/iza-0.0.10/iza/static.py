...
__all__ = ['NBKS_DIR', 'ROOT_DIR', 'EXPL_DIR', 'DATA_DIR', 'RESULTS_DIR', 'FIGURES_DIR', 'IZALITH_DATA_DIR', 'GIBBS_DATA_DIR',
           ...
           'OBSM', 'VARM', 'UNS', 'LAYER', 'LAYERS', 'HVG', 'PCA', 'UMAP', 'TSNE', 'PHATE', 'MAGIC', 'CELL', 'CELLS',
           'BARCODE', 'BARCODES', 'ID', 'MITO', 'RIBO', 'GENE', 'GENE_ID', 'GENE_IDS', 'GENE_SYMBOL', 'HIGHLY_VARIABLE',
           'ENSEMBL', 'ENSEMBL_ID', 'HUMAN', 'MOUSE', 'HUMAN_TF', 'MOUSE_TF', 'HUMAN_GENE_SYMBOL', 'HUMAN_ENSEMBLE_ID',
           'MOUSE_ENSEMBLE_ID', 'BATCH', 'TIMEPOINT', 'TIMEPOINTS', 'TOTAL_COUNTS', 'DOUBLET', 'DOUBLET_SCORES',
           'PREDICTED_DOUBLETS', 'PRENORM', 'DETECTED', 'SCALED_NORMALIZED', 'COUNTS', 'PCT', 'PERCENT', 'PCT_COUNTS',
           'PCT_COUNTS_MITO', 'PCT_COUNTS_RIBO', 'X', 'X_', 'X_PRENORM', 'X_DETECTED', 'X_SCALED_NORMALIZED', 'X_MAGIC',
           'X_PCA', 'X_PCA_HVG', 'X_PHATE', 'X_PHATE_HVG', 'ADATA', 'MATRIX', 'FEATURES', 'SENSITIVITY',
           ...
           'MARKERS_TROPHOBLAST', 'MARKERS_LISTS', 'MARKERS_ALL', 'LINEAGE_MARKERS', 'RC_PARAMS', 'SEQRUN', 'SEQRUNS',
           'TREATMENT', 'TREATMENTS', 'SENS', 'SENSITIVITIES']
