...
class _Pin:
    pin_name: str
    index: int
    func_call: Optional[QuantumFunctionCall]
...
class LogicFlowBuilder:
    ...
    def _verify_no_loops(self, dest_node: QuantumFunctionCall):
    ...
    def _connect_qubit_to_func_call(
        self, qubit: Qubit, dest_pin: _Pin, dest_node: Optional[QuantumFunctionCall]
    ) -> None:
    ...
    def _get_source_node_and_pin(
        self, qubit: Qubit
    ) -> Tuple[QuantumFunctionCall, _Pin]:
    ...
    def _connect_func_call_to_qubit(
        self, qubit: Qubit, source_pin: _Pin, source_node: QuantumFunctionCall
    ) -> None:
    ...
    def connect_qreg_to_func_call(
        ...
        source: QReg,
        dest_pin_name: str,
        dest_func_call: QuantumFunctionCall,
        pin_indices: Optional[range] = None,
    ) -> None:
    ...
    def connect_func_call_to_qreg(
        self, source_func_call: QuantumFunctionCall, source_pin_name: str, dest: QReg
    ) -> None:
