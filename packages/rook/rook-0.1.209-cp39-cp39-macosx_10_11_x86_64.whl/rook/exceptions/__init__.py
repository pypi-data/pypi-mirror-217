...
class RookRuleAugRateLimited(RookException):
    def __init__(self):
        super(RookRuleAugRateLimited, self).__init__("Breakpoint was disabled due to rate-limiting. "
                                                     "For more information: https://docs.rookout.com/docs/breakpoint-limits#rate-limiting")
...
class RookWebSocketError(RookException):
    def __init__(self, http_status):
        super(RookWebSocketError, self).__init__('Received HTTP status %d from the controller, please make sure WebSocket is enabled on the load balancer.' % http_status)
