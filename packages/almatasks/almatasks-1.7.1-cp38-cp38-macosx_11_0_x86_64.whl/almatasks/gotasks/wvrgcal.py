...
##################### d402f96194da43d686438cfb517b6265 ##############################
...
from almatasks.private.task_wvrgcal import wvrgcal as _wvrgcal_t
...
class _wvrgcal:
    ...
    def __offsetstable_inp(self):
        def xml_default( ):
            ...
            if dflt is not None: return dflt
            return ''
        description = '(experimental) subtract the temperature offsets in this table from the WVR measurements before calculating the phase corrections'
    ...
    def __call__( self, vis=None, caltable=None, toffset=None, segsource=None, sourceflag=None, tie=None, nsol=None, disperse=None, wvrflag=None, statfield=None, statsource=None, smooth=None, scale=None, spw=None, wvrspw=None, reversespw=None, cont=None, maxdistm=None, minnumants=None, mingoodfrac=None, usefieldtab=None, refant=None, offsetstable=None ):
        ...
        _arguments = [vis,caltable,toffset,segsource,sourceflag,tie,nsol,disperse,wvrflag,statfield,statsource,smooth,scale,spw,wvrspw,reversespw,cont,maxdistm,minnumants,mingoodfrac,usefieldtab,refant,offsetstable]
        _invocation_parameters = OrderedDict( )
        ...
        try:
            _return_result_ = _wvrgcal_t( _invocation_parameters['vis'],_invocation_parameters['caltable'],_invocation_parameters['toffset'],_invocation_parameters['segsource'],_invocation_parameters['sourceflag'],_invocation_parameters['tie'],_invocation_parameters['nsol'],_invocation_parameters['disperse'],_invocation_parameters['wvrflag'],_invocation_parameters['statfield'],_invocation_parameters['statsource'],_invocation_parameters['smooth'],_invocation_parameters['scale'],_invocation_parameters['spw'],_invocation_parameters['wvrspw'],_invocation_parameters['reversespw'],_invocation_parameters['cont'],_invocation_parameters['maxdistm'],_invocation_parameters['minnumants'],_invocation_parameters['mingoodfrac'],_invocation_parameters['usefieldtab'],_invocation_parameters['refant'],_invocation_parameters['offsetstable'] )
