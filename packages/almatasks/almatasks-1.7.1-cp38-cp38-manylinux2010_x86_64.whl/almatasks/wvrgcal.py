...
class _wvrgcal:
    ...
    def __call__( self, vis='', caltable='', toffset=float(0), segsource=True, sourceflag=[  ], tie=[  ], nsol=int(1), disperse=False, wvrflag=[  ], statfield='', statsource='', smooth='', scale=float(1.), spw=[  ], wvrspw=[  ], reversespw='', cont=False, maxdistm=float(500.), minnumants=int(2), mingoodfrac=float(0.8), usefieldtab=False, refant=[  ], offsetstable='' ):
