...
class MockMongo(InMemoryDatabase):
    ...
    async def upsert_admin(self, obj:   DesktopObject, collection: str, default_content: Optional[IO] = None):
        """
        ...
        if f is None:
            self.add_desktop_objects({collection: [obj.to_dict()]})
    ...
    async def insert_admin(self, obj: DesktopObject, collection: str,
