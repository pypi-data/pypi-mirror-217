...
from heaserver.service.db.aws import S3, S3Manager, S3WithMongoManager
...
class MockS3WithMongo(S3, MockMongo, InMemoryDatabase):
...
class S3WithDockerMongoManager(S3WithMongoManager, DockerMongoManager):
    pass
