...
class ChildOrganization(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name for Child Organization after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/child_organization#name ChildOrganization#name}
