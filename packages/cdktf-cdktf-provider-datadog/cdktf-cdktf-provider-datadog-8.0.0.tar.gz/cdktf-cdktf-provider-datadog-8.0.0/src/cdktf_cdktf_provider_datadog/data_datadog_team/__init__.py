...
class DataDatadogTeam(
    ...
    def __init__(
        ...
        *,
        ...
        :param filter_keyword: Search query. Can be team name, team handle, or email of team member. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/data-sources/team#filter_keyword DataDatadogTeam#filter_keyword}
        :param team_id: The team's identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/data-sources/team#team_id DataDatadogTeam#team_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
