...
class RestrictionPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param resource_id: Identifier for the resource, formatted as resource_type:resource_id. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/restriction_policy#resource_id RestrictionPolicy#resource_id}
        :param bindings: bindings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/restriction_policy#bindings RestrictionPolicy#bindings}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class RestrictionPolicyBindings:
    def __init__(
        ...
        *,
        ...
        '''
        :param principals: An array of principals. A principal is a subject or group of subjects. Each principal is formatted as ``type:id``. Supported types: ``role`` and ``org``. The org ID can be obtained through the api/v2/users API. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/restriction_policy#principals RestrictionPolicy#principals}
        :param relation: The role/level of access. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/restriction_policy#relation RestrictionPolicy#relation}
        '''
        if __debug__:
...
class RestrictionPolicyBindingsOutputReference(
    ...
    @jsii.member(jsii_name="resetRelation")
    def reset_relation(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetRelation", []))
