...
class IntegrationSlackChannel(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_name: Slack account name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#account_name IntegrationSlackChannel#account_name}
        :param channel_name: Slack channel name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#channel_name IntegrationSlackChannel#channel_name}
        :param display: display block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#display IntegrationSlackChannel#display}
    ...
    def put_display(
        ...
        *,
        ...
        '''
        :param message: Show the main body of the alert event. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#message IntegrationSlackChannel#message}
        :param notified: Show the list of.
        :param snapshot: Show the alert event's snapshot image. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#snapshot IntegrationSlackChannel#snapshot}
        :param tags: Show the scopes on which the monitor alerted. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/integration_slack_channel#tags IntegrationSlackChannel#tags}
        '''
