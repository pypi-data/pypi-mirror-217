...
class TeamLink(
    ...
    def __init__(
        ...
        *,
        ...
        :param label: The link's label. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/team_link#label TeamLink#label}
        :param team_id: ID of the team the link is associated with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/team_link#team_id TeamLink#team_id}
        :param url: The URL for the link. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/team_link#url TeamLink#url}
        :param position: The link's position, used to sort links for the team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/resources/team_link#position TeamLink#position}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
