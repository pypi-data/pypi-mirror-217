...
class DataDatadogTeamMemberships(
    ...
    def __init__(
        ...
        *,
        ...
        :param team_id: The team's identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/data-sources/team_memberships#team_id DataDatadogTeamMemberships#team_id}
        :param filter_keyword: Search query, can be user email or name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.27.0/docs/data-sources/team_memberships#filter_keyword DataDatadogTeamMemberships#filter_keyword}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
