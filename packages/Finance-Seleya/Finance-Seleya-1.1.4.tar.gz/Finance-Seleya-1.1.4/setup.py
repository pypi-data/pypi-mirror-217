...
ext_modules = [
    ...
    'seleya/mfc/alchemy/sbti/emission.pyx', 'seleya/mfc/alchemy/tsi/s2f.pyx',
    'seleya/mfc/alchemy/tsi/aerosol.pyx', 'seleya/Toolset/blob_service.pyx',
    'seleya/Toolset/file_util.pyx', 'seleya/Toolset/calendar.pyx',
