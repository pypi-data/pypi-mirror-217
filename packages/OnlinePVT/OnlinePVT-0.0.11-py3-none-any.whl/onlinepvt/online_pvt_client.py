...
from onlinepvt.models import CloudPointCalculationInput, CloudPointCalculationResult, \
...
class OnlinePvtClient:
    ...
    def get_unflashed_property_input(self):
        ...
        return UnflashedPropertyCalculationInput(user_id=self.__user_id, access_secret=self.__access_secret, units=self.__get_units(), components=[], fluid_id="", calculation_type="Fixed Temperature/Pressure")
