...
def test_create_deployed_item(endpoint_caller, auth_mock, netorca):
    ...
    """
    change_instance_uuid = "change_instance_uuid"
    ...
    result_caller = endpoint_caller.caller(
        "change_instances", "patch", id=change_instance_uuid, data={"deployed_item": description}
    )
    result_create_deployed_item = netorca.create_deployed_item(change_instance_uuid, description)
...
def test_get_deployed_item(endpoint_caller, auth_mock, netorca):
    ...
    result_caller = endpoint_caller.caller("deployed_items", "get", id=change_instance_uuid)
    result_get_deployed_item = netorca.get_deployed_item(change_instance_uuid)
...
def test_get_service_item(endpoint_caller, auth_mock, netorca):
    ...
    """
    service_item_uuid = "service_item_uuid"
    ...
    result_caller = endpoint_caller.caller("service_items", "get", id=service_item_uuid)
    result_get_service_item = netorca.get_service_item(service_item_uuid)
...
def test_get_change_instance(endpoint_caller, auth_mock, netorca):
    ...
    result_caller = endpoint_caller.caller("change_instances", "get", id=change_instance_uuid)
    result_get_change_instance = netorca.get_change_instance(change_instance_uuid)
...
def test_update_change_instance(endpoint_caller, auth_mock, netorca):
    ...
    result_caller = endpoint_caller.caller("change_instances", "update", id=change_instance_uuid, data=data)
    result_update_change_instance = netorca.update_change_instance(change_instance_uuid, data)
...
def test_get_service_config(endpoint_caller, auth_mock, netorca):
    ...
    """
    service_config_uuid = "service_config_uuid"
    ...
    result_caller = endpoint_caller.caller("service_configs", "get", id=service_config_uuid)
    result_get_service_config = netorca.get_service_config(service_config_uuid)
