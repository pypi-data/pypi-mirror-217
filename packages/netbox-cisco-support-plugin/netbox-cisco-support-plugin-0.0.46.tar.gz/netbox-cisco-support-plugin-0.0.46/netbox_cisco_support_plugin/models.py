...
class CiscoDeviceTypeSupport(ChangeLoggedModel):
    ...
    def save(self, *args, **kwargs):
        real_device_type = DeviceType.objects.select_related().get(device_type=self.device_type)

        self.name = real_device_type.display

        self.pid = real_device_type.part_number
