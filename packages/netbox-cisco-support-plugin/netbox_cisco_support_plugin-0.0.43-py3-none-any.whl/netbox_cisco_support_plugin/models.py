...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    def save(self, *args, **kwargs):
        # Compare the releases to set the status for the desired release to True or False
        ...
        # Compare the releases to set the status for the current release to True or False
