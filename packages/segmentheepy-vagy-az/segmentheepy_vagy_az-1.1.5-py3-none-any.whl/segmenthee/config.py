...
class Config:
    ...
    SHOP_URL = os.environ.get('SHOP_URL', 'https://www.vagyaim.hu')
    SCORE_THRESHOLD = float(os.environ.get('SCORE_THRESHOLD', 0.36))
    SCORE_EPS = float(os.environ.get('SCORE_EPS', 0.09))
    FRUSTRATION_TOLERANCE = float(os.environ.get('SCORE_EPS', 0.5))
