...
def get_nu_search_limits(filename, freq_search_interval=0.2, plot_filename=None, min_frequency=1e-4, max_frequency=10., orbitfile=None):
...
def get_phases(pp, dpp, ind_selected, ee_pulsed=None, dee_pulsed=None, plot=True,
    ...
    phi0=align_phases(np.array(phases),margin=margin, debug=debug, distance_factor=distance_factor)
