...
setup(
  name = 'Websocketee',         # How you named your package folder (MyLib)
  packages = ['Websocketee'],   # Chose the same as "name"
  ...
  install_requires=['websocket-client','fake_useragent','requests','flask'],
  classifiers=[
