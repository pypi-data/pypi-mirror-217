...
class LogRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["function_name", "function_id", "session_id", "session_reference_id", "parent_id", "parent_reference_id", "inputs", "source", "metadata", "reference_id", "trial_id", "messages", "output", "config", "feedback", "created_at", "error", "duration", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["function_name"]) -> typing.Union[MetaOapg.properties.function_name, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["function_name", "function_id", "session_id", "session_reference_id", "parent_id", "parent_reference_id", "inputs", "source", "metadata", "reference_id", "trial_id", "messages", "output", "config", "feedback", "created_at", "error", "duration", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        function_name: typing.Union[MetaOapg.properties.function_name, str, schemas.Unset] = schemas.unset,
