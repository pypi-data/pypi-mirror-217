...
class LogResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["config", "id", "function_name", "function_id", "session_id", "session_reference_id", "parent_id", "parent_reference_id", "inputs", "source", "metadata", "reference_id", "trial_id", "messages", "output", "feedback", "created_at", "error", "duration", "model_config", "user", "provider_response", "provider_latency", "raw_output", "finish_reason", ], str]):
