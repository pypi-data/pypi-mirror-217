...
@jsii.data_type(
    jsii_type="aws-vpclattice-prealpha.AddRuleProps",
    jsii_struct_bases=[],
    name_mapping={
        "action": "action",
...
class AddRuleProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5d83940d24c0f4abfefc2a3caed0d7b9c7a352817dcd16147f97c43cced0adb8)
    ...
    def action(
        self,
    ) -> typing.Union["FixedResponse", typing.List["WeightedTargetGroup"]]:
...
class HealthCheck(
    ...
    jsii_type="aws-vpclattice-prealpha.HealthCheck",
):
    '''(experimental) Create a Health Check for a target.
    ...
    def check(
        ...
        *,
        ...
        health_check_interval: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
        health_check_timeout: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
        healthy_threshold_count: typing.Optional[jsii.Number] = None,
        matcher: typing.Optional[FixedResponse] = None,
        path: typing.Optional[builtins.str] = None,
        port: typing.Optional[jsii.Number] = None,
        protocol: typing.Optional["Protocol"] = None,
        protocol_version: typing.Optional["ProtocolVersion"] = None,
        unhealthy_threshold_count: typing.Optional[jsii.Number] = None,
    ) -> "HealthCheck":
        '''(experimental) A Health Check configuration object for a target.

        :param enabled: (experimental) Enable this Health Check. Default: true
        :param health_check_interval: (experimental) Health Check Interval. Default: 30 seconds
        :param health_check_timeout: (experimental) TimeOut Period. Default: 5 seconds
        :param healthy_threshold_count: (experimental) Number of Healthy Responses before Target is considered healthy. Default: 2
        :param matcher: (experimental) Check based on Response from target. Default: 200 OK
        :param path: (experimental) Path to use for Health Check. Default: '/'
        :param port: (experimental) Port to use for Health Check. Default: 443
        :param protocol: (experimental) Protocol to use for Health Check. Default: HTTPS
        :param protocol_version: (experimental) Protocol to use for Health Check. Default: HTTP2
        :param unhealthy_threshold_count: (experimental) Number of unhealty events before Target is considered unhealthy. Default: 1

        :return: HealthCheck

        :stability: experimental
        '''
        props = TargetGroupHealthCheckProps(
            enabled=enabled,
        ...
        return typing.cast("HealthCheck", jsii.sinvoke(cls, "check", [props]))

    @builtins.property
    @jsii.member(jsii_name="enabled")
    @abc.abstractmethod
    def enabled(self) -> builtins.bool:
        '''(experimental) health check is enabled.
    ...
    @abc.abstractmethod
    def health_check_interval(self) -> _aws_cdk_ceddda9d.Duration:
        '''(experimental) healthCheck Interval.
    ...
    @abc.abstractmethod
    def health_check_timeout(self) -> _aws_cdk_ceddda9d.Duration:
        '''(experimental) HealthCheck Timeout.
    ...
    def healthy_threshold_count(self) -> jsii.Number:
        '''(experimental) Healthy Threshold Count.
    ...
    def protocol_version(self) -> builtins.str:
        '''(experimental) HTTP Protocol Version.
    ...
    def unhealthy_threshold_count(self) -> jsii.Number:
        '''(experimental) Unhealthy Threshold Count.
    ...
    def matcher(
        self,
    ) -> typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnTargetGroup.MatcherProperty]:
        '''(experimental) Target Match reponse.
...
class _HealthCheckProxy(HealthCheck):
    ...
    def health_check_interval(self) -> _aws_cdk_ceddda9d.Duration:
        ...
        :stability: experimental
        '''
        return typing.cast(_aws_cdk_ceddda9d.Duration, jsii.get(self, "healthCheckInterval"))
    ...
    def health_check_timeout(self) -> _aws_cdk_ceddda9d.Duration:
        ...
        :stability: experimental
        '''
        return typing.cast(_aws_cdk_ceddda9d.Duration, jsii.get(self, "healthCheckTimeout"))
    ...
    def matcher(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnTargetGroup.MatcherProperty], jsii.get(self, "matcher"))
...
class IService(_aws_cdk_ceddda9d.IResource, typing_extensions.Protocol):
    ...
    def dns_entry(
        self,
    ) -> typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty]:
    ...
    def dns_entry(
        self,
        value: typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty],
    ) -> None:
        ...
...
class _IServiceProxy(
    ...
    def dns_entry(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty], jsii.get(self, "dnsEntry"))
    ...
    def dns_entry(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__cfb0923f23925de9fad4e28431f41acca80ea172a4f969d58a807a85d5da165c)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
@jsii.enum(jsii_type="aws-vpclattice-prealpha.IpAddressType")
class IpAddressType(enum.Enum):
    '''(experimental) IpAddressType.
...
class Listener(
    ...
    def __init__(
        ...
        *,
        service: IService,
        default_action: typing.Optional[typing.Union[_aws_cdk_aws_vpclattice_ceddda9d.CfnListener.DefaultActionProperty, typing.Dict[builtins.str, typing.Any]]] = None,
...
class ListenerProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(default_action, dict):
            default_action = _aws_cdk_aws_vpclattice_ceddda9d.CfnListener.DefaultActionProperty(**default_action)
        if __debug__:
    ...
    def default_action(
        self,
    ) -> typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnListener.DefaultActionProperty]:
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnListener.DefaultActionProperty], result)
...
@jsii.enum(jsii_type="aws-vpclattice-prealpha.ProtocolVersion")
class ProtocolVersion(enum.Enum):
    '''(experimental) ProtocolVersion.
...
class Service(
    ...
    def __init__(
        ...
        *,
        ...
        dns_entry: typing.Optional[typing.Union[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param dns_entry: (experimental) A custom hosname. Default: no hostname is used
    ...
    def from_id(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__58c9574f37acc0e2a6abb9dec79a5f5174a292f43234da601cf6f389a8bfc3a1)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument service_id", value=service_id, expected_type=type_hints["service_id"])
        return typing.cast(IService, jsii.sinvoke(cls, "fromId", [scope, id, service_id]))
    ...
    def dns_entry(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__60773751be558cfaa35399c92545a40c7a080091cfac86381916982f0e170e24)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "dnsEntry", value)
    ...
    def from_id(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = ImportedServiceNetworkProps(
            service_network_id=service_network_id,
            service_network_name=service_network_name,
        )

        return typing.cast(IServiceNetwork, jsii.sinvoke(cls, "fromId", [scope, id, props]))
...
class ServiceProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(dns_entry, dict):
            dns_entry = _aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty(**dns_entry)
        if __debug__:
    ...
    def dns_entry(
        ...
        return typing.cast(typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty], result)
...
class Target(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="aws-vpclattice-prealpha.Target",
):
    '''(experimental) Targets for target Groups.
    ...
    def application_load_balancer(
        cls,
        alb: typing.Sequence[_aws_cdk_aws_elasticloadbalancingv2_ceddda9d.ApplicationLoadBalancer],
        *,
        vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
        healthcheck: typing.Optional[HealthCheck] = None,
        ip_address_type: typing.Optional[IpAddressType] = None,
        port: typing.Optional[jsii.Number] = None,
        protocol: typing.Optional[Protocol] = None,
        protocol_version: typing.Optional[ProtocolVersion] = None,
    ) -> "Target":
        '''(experimental) Application Load Balancer as Targets.

        :param alb: -
        :param vpc: (experimental) VPC where the target(s) are located.
        :param healthcheck: (experimental) HealthCheckParameters - Can supply for IpAddress and ALB targets only. Default: No HealthCheck
        :param ip_address_type: (experimental) IpAddressType. Default: IPv4
        :param port: (experimental) Port. Default: Defaults to port 80 for HTTP, or 443 for HTTPS and GRPC
        :param protocol: (experimental) Protocol. Default: HTTPS
        :param protocol_version: (experimental) ProtocolVersion. Default: HTTP1

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f666eec9816c5568af92be0a5d3fc04fce4e28b492feba114b84a93f7e2a5f01)
        ...
        return typing.cast("Target", jsii.sinvoke(cls, "applicationLoadBalancer", [alb, target_config]))

    @jsii.member(jsii_name="ec2instance")
    @builtins.classmethod
    def ec2instance(
        cls,
        ec2instance: typing.Sequence[_aws_cdk_aws_ec2_ceddda9d.Instance],
        *,
        vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
        healthcheck: typing.Optional[HealthCheck] = None,
        ip_address_type: typing.Optional[IpAddressType] = None,
        ...
        '''(experimental) EC2 Instances as Targets.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fa5e22e69e1f5dda1e86eaf0585687d90d45b584e39b8596cc9c24053ea8aa47)
            check_type(argname="argument ec2instance", value=ec2instance, expected_type=type_hints["ec2instance"])
        target_config = TargetConfig(
            vpc=vpc,
            healthcheck=healthcheck,
            ip_address_type=ip_address_type,
        ...
        return typing.cast("Target", jsii.sinvoke(cls, "ec2instance", [ec2instance, target_config]))

    @jsii.member(jsii_name="ipAddress")
    @builtins.classmethod
    def ip_address(
        cls,
        ip_address: typing.Sequence[builtins.str],
        *,
        vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
        healthcheck: typing.Optional[HealthCheck] = None,
        ip_address_type: typing.Optional[IpAddressType] = None,
        ...
        '''(experimental) IpAddress as Targets.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ffcd157d3a6a2f3690731c159c9401ec89562a22e0e655b25bf47d883685f0aa)
        ...
        return typing.cast("Target", jsii.sinvoke(cls, "ipAddress", [ip_address, target_config]))

    @jsii.member(jsii_name="lambda")
    @builtins.classmethod
    def lambda_(
        cls,
        lambda_: typing.Sequence[_aws_cdk_aws_lambda_ceddda9d.Function],
    ) -> "Target":
        '''(experimental) Lambda Target - Note: Lambda Targets do not have a configuration.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__78a220f0e8181120274f202b019dde6988689054b526a73900691a3082e17ad9)
            check_type(argname="argument lambda_", value=lambda_, expected_type=type_hints["lambda_"])
        return typing.cast("Target", jsii.sinvoke(cls, "lambda", [lambda_]))
    ...
    def type(self) -> "TargetType":
        '''(experimental) The type of target.
...
class _TargetProxy(Target):
    ...
    def type(self) -> "TargetType":
        ...
        :stability: experimental
        '''
        return typing.cast("TargetType", jsii.get(self, "type"))
...
# Adding a "__jsii_proxy_class__(): typing.Type" function to the abstract class
typing.cast(typing.Any, Target).__jsii_proxy_class__ = lambda : _TargetProxy


@jsii.data_type(
    jsii_type="aws-vpclattice-prealpha.TargetConfig",
    jsii_struct_bases=[],
    name_mapping={
        "vpc": "vpc",
        "healthcheck": "healthcheck",
...
class TargetConfig:
    def __init__(
        ...
        *,
        ...
        '''(experimental) TargetConfiguration.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be563b2ea024e84be3bd5304ab522e77ae1da1818db5ac85627b2be96a23daa0)
            check_type(argname="argument vpc", value=vpc, expected_type=type_hints["vpc"])
    ...
    @builtins.property
    def vpc(self) -> _aws_cdk_aws_ec2_ceddda9d.IVpc:
        '''(experimental) VPC where the target(s) are located.
    ...
    @builtins.property
    def healthcheck(self) -> typing.Optional[HealthCheck]:
        '''(experimental) HealthCheckParameters - Can supply for IpAddress and ALB targets only.
    ...
    @builtins.property
    def protocol_version(self) -> typing.Optional[ProtocolVersion]:
        '''(experimental) ProtocolVersion.
        ...
        return typing.cast(typing.Optional[ProtocolVersion], result)
...
@jsii.data_type(
    jsii_type="aws-vpclattice-prealpha.TargetGroupHealthCheckProps",
    jsii_struct_bases=[],
    name_mapping={
        "enabled": "enabled",
...
class TargetGroupHealthCheckProps:
    def __init__(
        self,
        *,
        enabled: typing.Optional[builtins.bool] = None,
        ...
        '''(experimental) A Configuration of the TargetGroup Health Check.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__52afe14debb68c71bf645cfbf26d6dc9ce721581680e79f9363f016ca8949277)
    ...
    def enabled(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Enable this Health Check.
    ...
    @builtins.property
    def health_check_interval(self) -> typing.Optional[_aws_cdk_ceddda9d.Duration]:
        '''(experimental) Health Check Interval.
    ...
    @builtins.property
    def health_check_timeout(self) -> typing.Optional[_aws_cdk_ceddda9d.Duration]:
        '''(experimental) TimeOut Period.
    ...
    def healthy_threshold_count(self) -> typing.Optional[jsii.Number]:
        '''(experimental) Number of Healthy Responses before Target is considered healthy.
    ...
    @builtins.property
    def matcher(self) -> typing.Optional[FixedResponse]:
        '''(experimental) Check based on Response from target.
    ...
    def path(self) -> typing.Optional[builtins.str]:
        '''(experimental) Path to use for Health Check.
    ...
    @builtins.property
    def port(self) -> typing.Optional[jsii.Number]:
        '''(experimental) Port to use for Health Check.
    ...
    @builtins.property
    def protocol(self) -> typing.Optional[Protocol]:
        '''(experimental) Protocol to use for Health Check.
    ...
    def unhealthy_threshold_count(self) -> typing.Optional[jsii.Number]:
        '''(experimental) Number of unhealty events before Target is considered unhealthy.
    ...
    def __repr__(self) -> str:
        return "TargetGroupHealthCheckProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class TargetGroupProps:
    def __init__(self, *, name: builtins.str, target: Target) -> None:
    ...
    def target(self) -> Target:
        ...
        return typing.cast(Target, result)
...
@jsii.enum(jsii_type="aws-vpclattice-prealpha.TargetType")
class TargetType(enum.Enum):
    '''(experimental) Types of Targets that are usable with vpclattice.

    :stability: experimental
    '''

    LAMBDA = "LAMBDA"
    '''(experimental) Lambda Target.

    :stability: experimental
    '''
    IP = "IP"
    '''(experimental) IP Address Target.

    :stability: experimental
    '''
    INSTANCE = "INSTANCE"
    '''(experimental) EC2 Instance Targets.

    :stability: experimental
    '''
    ALB = "ALB"
    '''(experimental) Application Load Balancer Target.
...
class WeightedTargetGroup:
    def __init__(
        ...
        *,
        ...
        '''(experimental) A weighted target group adds a weighting to a target group.
...
def _typecheckingstub__5d83940d24c0f4abfefc2a3caed0d7b9c7a352817dcd16147f97c43cced0adb8(
    *,
    action: typing.Union[FixedResponse, typing.Sequence[typing.Union[WeightedTargetGroup, typing.Dict[builtins.str, typing.Any]]]],
    http_match: typing.Union[HTTPMatch, typing.Dict[builtins.str, typing.Any]],
    name: builtins.str,
...
def _typecheckingstub__cfb0923f23925de9fad4e28431f41acca80ea172a4f969d58a807a85d5da165c(
    value: typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__58c9574f37acc0e2a6abb9dec79a5f5174a292f43234da601cf6f389a8bfc3a1(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    service_id: builtins.str,
) -> None:
...
def _typecheckingstub__60773751be558cfaa35399c92545a40c7a080091cfac86381916982f0e170e24(
    value: typing.Optional[_aws_cdk_aws_vpclattice_ceddda9d.CfnService.DnsEntryProperty],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__f666eec9816c5568af92be0a5d3fc04fce4e28b492feba114b84a93f7e2a5f01(
    alb: typing.Sequence[_aws_cdk_aws_elasticloadbalancingv2_ceddda9d.ApplicationLoadBalancer],
    *,
    vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
    healthcheck: typing.Optional[HealthCheck] = None,
...
def _typecheckingstub__fa5e22e69e1f5dda1e86eaf0585687d90d45b584e39b8596cc9c24053ea8aa47(
    ec2instance: typing.Sequence[_aws_cdk_aws_ec2_ceddda9d.Instance],
    *,
    vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
    healthcheck: typing.Optional[HealthCheck] = None,
...
def _typecheckingstub__ffcd157d3a6a2f3690731c159c9401ec89562a22e0e655b25bf47d883685f0aa(
    ip_address: typing.Sequence[builtins.str],
    *,
    vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
    healthcheck: typing.Optional[HealthCheck] = None,
...
def _typecheckingstub__78a220f0e8181120274f202b019dde6988689054b526a73900691a3082e17ad9(
    lambda_: typing.Sequence[_aws_cdk_aws_lambda_ceddda9d.Function],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__be563b2ea024e84be3bd5304ab522e77ae1da1818db5ac85627b2be96a23daa0(
    *,
    vpc: _aws_cdk_aws_ec2_ceddda9d.IVpc,
    healthcheck: typing.Optional[HealthCheck] = None,
    ip_address_type: typing.Optional[IpAddressType] = None,
...
def _typecheckingstub__52afe14debb68c71bf645cfbf26d6dc9ce721581680e79f9363f016ca8949277(
    *,
    enabled: typing.Optional[builtins.bool] = None,
    health_check_interval: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
    health_check_timeout: typing.Optional[_aws_cdk_ceddda9d.Duration] = None,
