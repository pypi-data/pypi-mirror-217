...
def get_property(property, driver=None, debug=False):
    # Variables
    properties = ["rate", "voice", "voices", "volume"]
...
# Function 2 - Say
def say(text, rate=200, voice=get_property("voices")[0].id, volume=1.0, onStart=None, onWord=None, onEnd=None, onError=None, driver=None, debug=False):
    # List of Drivers
    drivers = ["sapi5", "nsss", "espeak"]
                    ...
                    if (isinstance(driver, str) or (driver == None)):
                        ...
                        if (isinstance(debug, bool)):
                            ...
                            try:
                                ...
                                if ((onWord != None) and (callable(onWord))):
...
# Function 3 - Save
def save(text, path, rate=200, voice=get_property("voices")[0].id, volume=1.0, onStart=None, onWord=None, onEnd=None, onError=None, driver=None, debug=False):
    # List of Drivers
    drivers = ["sapi5", "nsss", "espeak"]
