...
def income_statement(ticker, api_key, period="annual", as_reported=False, limit=0):
    ...
    if as_reported:
        URL = (
            f"https://financialmodelingprep.com/api/v3/income-statement-as-reported/{ticker}"
...
def balance_sheet_statement(
    ticker, api_key, period="annual", as_reported=False, limit=0
):
    """
    Description
    ----
    ...
    if as_reported:
        URL = (
            f"https://financialmodelingprep.com/api/v3/balance-sheet-statement-as-reported/{ticker}"
            f"?period={period}&limit={limit}&apikey={api_key}"
        )
    else:
        URL = (
...
def cash_flow_statement(ticker, api_key, period="annual", as_reported=False, limit=0):
    ...
    if as_reported:
        URL = (
            f"https://financialmodelingprep.com/api/v3/cash-flow-statement-as-reported/{ticker}"
            f"?period={period}&limit={limit}&apikey={api_key}"
        )
    else:
        URL = (
