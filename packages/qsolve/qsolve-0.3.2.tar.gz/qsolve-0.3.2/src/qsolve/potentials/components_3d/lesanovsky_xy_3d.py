...
def eval_potential_lesanovsky_xy_3d(x_3d, y_3d, z_3d, g_F, m_F, m_F_prime, omega_perp, omega_para, omega_delta_detuning,
    ...
    # remove z-dependency
    z_3d = torch.zeros((1, 1, Jz), dtype=torch.float64, device=device)
