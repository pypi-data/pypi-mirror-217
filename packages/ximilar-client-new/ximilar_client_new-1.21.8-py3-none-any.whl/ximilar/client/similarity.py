...
class CustomSimilarityClient(RecognitionClient):
    ...
    def get_groups_url(self, page_url=None, search=None, test=None, image=None, group=None, empty=None, type=None):
        url = (
    ...
    def get_groups(self, page_url=None, search=None, test=None, image=None, group=None, empty=None, type=None):
        url = self.get_groups_url(page_url, search, test, image, group, empty, type)
