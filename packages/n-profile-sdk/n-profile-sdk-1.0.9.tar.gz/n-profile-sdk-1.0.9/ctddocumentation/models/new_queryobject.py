...
from ctddocumentation.models.queryextraparams import Queryextraparams


class NewQueryobject(object):

    """Implementation of the 'NewQueryobject' model.
    ...
    Attributes:
        ...
        extra_params (Queryextraparams): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the NewQueryobject class"""
    ...
    def from_dictionary(cls,
        ...
        extra_params = Queryextraparams.from_dictionary(dictionary.get('extra_params')) if 'extra_params' in dictionary.keys() else APIHelper.SKIP
