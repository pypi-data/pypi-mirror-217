...
from ctddocumentation.models.event import Event


class GetEventsResponse(object):

    """Implementation of the 'GetEventsResponse' model.
    ...
    Attributes:
        ...
        objects (list of Event): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetEventsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [Event.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
