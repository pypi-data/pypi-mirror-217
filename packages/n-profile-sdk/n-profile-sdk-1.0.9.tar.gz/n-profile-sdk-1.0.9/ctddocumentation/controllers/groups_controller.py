...
from ctddocumentation.models.create_group_response import CreateGroupResponse
...
class GroupsController(BaseController):
    ...
    def create_group(self,
                     body):
        """Does a POST request to /auth/groups.

        This can only be done by the logged in user.

        Args:
            body (Group): Created group object

        Returns:
            CreateGroupResponse: Response from the API. Successful Operation
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(CreateGroupResponse.from_dictionary)
        ).execute()
