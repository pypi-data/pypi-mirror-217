...
from ctddocumentation.models.task import Task


class GetQueriesResponse(object):

    """Implementation of the 'GetQueriesResponse' model.
    ...
    Attributes:
        ...
        objects (list of Task): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetQueriesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [Task.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
