...
class GetAlertsResponse(object):

    """Implementation of the 'GetAlertsResponse' model.
    ...
    Attributes:
        ...
        objects (list of Alert): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetAlertsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [Alert.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
