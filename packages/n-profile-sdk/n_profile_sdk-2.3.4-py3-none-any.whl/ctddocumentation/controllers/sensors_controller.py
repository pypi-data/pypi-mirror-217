...
from ctddocumentation.models.ranger_system_check_response import RangerSystemCheckResponse
...
class SensorsController(BaseController):
    ...
    def __init__(self, config):
        super(SensorsController, self).__init__(config)

    def get_sensors(self,
                    site_id):
        """Does a GET request to /ranger/system/check.
        ...
        Returns:
            RangerSystemCheckResponse: Response from the API. Successful
                Operation
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(RangerSystemCheckResponse.from_dictionary)
        ).execute()
