...
from ctddocumentation.models.site import Site


class GetAllSitesResponse(object):

    """Implementation of the 'GetAllSitesResponse' model.
    ...
    Attributes:
        ...
        objects (list of Site): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetAllSitesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [Site.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
