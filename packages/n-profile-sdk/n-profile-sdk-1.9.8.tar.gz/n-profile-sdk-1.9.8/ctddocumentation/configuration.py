...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(
        ...
        host='HostValue', authorization='TODO: Replace'
    ):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        return Configuration(
            ...
            environment=environment, host=host, authorization=authorization
        )
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "Host": {'value': self.host, 'encode': False},
        }
