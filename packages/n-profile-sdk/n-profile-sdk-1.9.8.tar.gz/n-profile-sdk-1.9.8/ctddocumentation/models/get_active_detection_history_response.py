...
from ctddocumentation.models.active_history import ActiveHistory


class GetActiveDetectionHistoryResponse(object):

    """Implementation of the 'GetActiveDetectionHistoryResponse' model.
    ...
    Attributes:
        ...
        objects (list of ActiveHistory): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetActiveDetectionHistoryResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [ActiveHistory.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
