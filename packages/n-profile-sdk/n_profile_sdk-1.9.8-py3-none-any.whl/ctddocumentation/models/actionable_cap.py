...
from ctddocumentation.models.cap import Cap


class ActionableCap(object):

    """Implementation of the 'ActionableCap' model.
    ...
    Attributes:
        ...
        cap (Cap): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 cap=APIHelper.SKIP):
        """Constructor for the ActionableCap class"""
    ...
    def from_dictionary(cls,
        ...
        cap = Cap.from_dictionary(dictionary.get('cap')) if 'cap' in dictionary.keys() else APIHelper.SKIP
