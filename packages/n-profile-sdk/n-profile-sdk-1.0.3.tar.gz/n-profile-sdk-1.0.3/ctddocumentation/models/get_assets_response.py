...
from ctddocumentation.models.asset import Asset


class GetAssetsResponse(object):

    """Implementation of the 'GetAssetsResponse' model.
    ...
    Attributes:
        ...
        objects (list of Asset): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetAssetsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('objects') is not None:
            objects = [Asset.from_dictionary(x) for x in dictionary.get('objects')]
        else:
            objects = APIHelper.SKIP
