...
def CustomRelationship(*args, **kwargs):
    return Relationship_(
        *args,
        **kwargs,
        sa_relationship_kwargs={
...
class ResultsSet(SQLModel, table=True):
    ...
    segment_details: List["SegmentDetails"] = CustomRelationship()
    wheel_bay_details: List["ResultsSetWheelBayDetails"] = CustomRelationship()
...
class ResultsSetWheelBayDetails(SQLModel, table=True):
    ...
    microphone_details: List["ResultsSetMicrophoneDetails"] = CustomRelationship()
...
class SegmentDetails(SQLModel, table=True):
    ...
    wheel_bay_details: List["SegmentWheelBayDetails"] = CustomRelationship()
...
class SegmentWheelBayDetails(SQLModel, table=True):
    ...
    microphone_details: List["SegmentMicrophoneDetails"] = CustomRelationship()
    wheel_bay_third_octave_levels: List[
        "WheelBayThirdOctaveLevels"
    ] = CustomRelationship()
    wheel_bay_texture_results: Optional[
        List["WheelBayTextureResults"]
    ] = CustomRelationship()
...
class SegmentMicrophoneDetails(SQLModel, table=True):
    ...
    microphone_third_octave_levels: List[
        "MicrophoneThirdOctaveLevels"
    ] = CustomRelationship()
