...
from owe_python_sdk.client.utils import adapt_runner
from owe_python_sdk.client.errors import RunnerAdaptationError
...
class Runnable:
    def _set_runner(self, runner: Runner=None):
        ...
        try:
            if runner != None and not isinstance(runner) == Runner:
                runner = adapt_runner(runner.__class__)()
...
class Pipeline(Runnable):
    ...
    def start(self, params: owe_schema.KeyVal={}):
        ...
        self.runner.submit(self.schema.dict(), params=params)
