...
def _export_version(version, sha):
    version_path = ROOT_DIR / "hegel" / "version.py"
...
class Clean(distutils.command.clean.clean):
    def run(self):
        ...
        # Remove hegel extension
        def remove_extension(pattern):
            for path in (ROOT_DIR / "hegel").glob(pattern):
        ...
        build_dirs = [
            ...
            ROOT_DIR / "hegel.egg-info",  # Remove egg metadata
        ]
...
if __name__ == "__main__":
    ...
    setup(
        ...
        url="https://github.com/hegelai/hegel",
        author="Hegel AI",
