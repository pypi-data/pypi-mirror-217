...
class gDriveExplorer:
    ...
    def scan_csv(self, path_from_base, is_large=True, **kwargs):
        ...
        if is_large:
            ...
            df_ = polars.scan_csv(name, **kwargs)
            ...
            return polars.scan_csv(io.StringIO(self.get_file_from_path(path_from_base).decode(decode)), **kwargs)
