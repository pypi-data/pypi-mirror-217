...
- childrenOrder (list of strings; optional)"""
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, childrenOrder=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'childrenOrder']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'childrenOrder']
