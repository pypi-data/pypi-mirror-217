...
from .types.model_prompt import ModelPrompt
...
class Chima:
    ...
    def stream(self, *, level_context: str, model_prompt: typing.List[ModelPrompt]) -> typing.Iterator[str]:
        with httpx.stream(
            "POST",
...
class AsyncChima:
    ...
    async def stream(self, *, level_context: str, model_prompt: typing.List[ModelPrompt]) -> typing.AsyncIterator[str]:
        async with httpx.AsyncClient() as _client:
