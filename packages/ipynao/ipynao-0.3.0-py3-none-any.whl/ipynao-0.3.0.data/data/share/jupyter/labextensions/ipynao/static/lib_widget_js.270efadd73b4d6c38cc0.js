...
class NaoRobotModel extends base_1.DOMWidgetModel {
    ...
    checkConnection() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.qiSession.isConnected()) {
                yield this.connect(this._ipAddress, this._port);
            }
            return true;
        });
    }
    createService(serviceName) {
        return __awaiter(this, void 0, void 0, function* () {
            const isConnected = yield this.checkConnection();
            if (!isConnected) {
                return;
            }
    ...
    callService(serviceName, methodName, args, _kwargs) {
        return __awaiter(this, void 0, void 0, function* () {
            const isConnected = yield this.checkConnection();
            if (!isConnected) {
                return;
    ...
    onCommand(commandData, buffers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (cmd) {
                case 'connect':
                    yield this.connect(commandData['ipAddress'], commandData['port']);
                    break;
                case 'disconnect':
                    this.disconnect();
                    break;
