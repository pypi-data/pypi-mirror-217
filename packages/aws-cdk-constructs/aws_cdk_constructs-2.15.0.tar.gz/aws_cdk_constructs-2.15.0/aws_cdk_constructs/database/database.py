...
class Database(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        identifier_postfix = f"-{database_identifier_postfix}" if database_identifier_postfix else ""
        ...
        cdk.CfnOutput(self, f"DatabaseIdentifierPrefix{app_name}{output_id}", value=str(database_identifier))
