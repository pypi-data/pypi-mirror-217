...
class PyPL2FileReader:
    def __init__(self, pl2_dll_path = 'bin'):
        ...
        if self.platform == '32bit':
            # self.pl2_dll_file = os.path.join(self.pl2_dll_path, 'PL2FileReader.dll') # updated by Nikhil outside of repo
            # self.pl2_dll_file = str(Path(__file__).parent.parent / "bin" / "PL2FileReader.dll")
            self.pl2_dll_file = str(Path(__file__).parent.parent / "bin" / "PL2FileReader.dll")
        else:
            # self.pl2_dll_file = os.path.join(self.pl2_dll_path, 'PL2FileReader64.dll') # updated by Nikhil outside of repo
