...
class OIDCAuthenticationBackend(ModelBackend):
    ...
    def authenticate(self,request, **kwargs):
        ...
        # Get the token
        print("before token_info")
        token_info = self.get_token(token_payload)
        print("after token_info")
    ...
    def get_token(self, payload):
        ...
        print("before response get_token")
        print("payload",payload)
        print("auth",auth)
        print("self.OIDC_VERIFY_SSL",self.OIDC_VERIFY_SSL)
        print("self.OIDC_TIMEOUT",self.OIDC_TIMEOUT)
        print("self.OIDC_PROXY",self.OIDC_PROXY)
        ...
        print("after response get_token")
        print(response.text)
        print(response.json())
