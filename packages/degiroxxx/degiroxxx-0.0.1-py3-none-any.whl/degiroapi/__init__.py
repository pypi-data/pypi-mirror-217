...
class DeGiro:
    ...
    def buyorder(self, orderType, productId, timeType, size, intAccount, limit=None, stop_loss=None):
        place_buy_order_params = {
            'intAccount': str(intAccount),
            'sessionId': self.session_id,
        }
    ...
    def sellorder(self, orderType, productId, timeType, size, intAccount, limit=None, stop_loss=None):
