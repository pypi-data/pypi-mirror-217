...
class UserData(Base, User):
    ...
    equipes = relationship("UserData", secondary="Equipes_Users", overlaps="users")
    ...
    def update_user_teams_link(self, equipes: List[Equipes], session=Session):
        return self.repository.link(second_relation_objects=equipes, method=self.toggle_user_equipe_link,
                                    db_session=session)
