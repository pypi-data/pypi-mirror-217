...
class MicrosoftDataODataQuerySemanticAstSelectItem:
    ...
    def __init__(self, _configuration=None):
        """MicrosoftDataODataQuerySemanticAstSelectItem - a model defined in Swagger"""
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MicrosoftDataODataQuerySemanticAstSelectItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MicrosoftDataODataQuerySemanticAstSelectItem):
            return False
