...
class RequestDestination(BaseModel):
    ...
    If not specified, then the Request will never expire.
    """
...
class RequestDestinationFallback(BaseModel):
    ...
    The next :class:`~sym.sdk.request_destination.RequestDestination` will be attempted based on the failure mode configuration.
    """
