...
def user(identifier: Union[str, User], allow_self: bool = False) -> SlackUser:
    """A reference to a Slack user.

    Args:
        identifier: The unique Slack user ID, email, or @mention for a Slack user, or a Sym :class:`~sym.sdk.user.User` instance. (e.g. "U12345", "jane\@symops.io", "@Jane Austen").
