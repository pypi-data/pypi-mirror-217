...
class QuestionAnswerModel:
    ...
    def load_question_answer(self, data):
        ...
        question_answer_objects = [
            [Question(question=d["question"]), Answer(answer=d["answer"])] for d in data
        ]
    ...
    def train(
        ...
        """
        self.llm.save_data(self.question_answer)
        self.llm.save_data(self.documents)
        final_status = self.llm.train(prompt_key="dolly", verbose=verbose)
