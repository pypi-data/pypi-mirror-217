...
from ..constants import HfTrainerMethodsConstants, HfTrainerType, AzuremlRunType, RunPropertyConstants
...
class FinetuneCallback(TrainerCallback):
    ...
    def on_train_end(self, args, state, control, **kwargs):
        ...
        self.azureml_run.add_properties(properties)
        logger.info(f"Best metric properties set on run")
        parent_run = self._should_log_to_parent()
        if parent_run:
            parent_run.add_properties(properties)
