...
setup(
	...
	doc_files = ['micomputing/metrics.py', 'micomputing/old_versions', 'micomputing/plot.py', 'micomputing/__init__.py', 'micomputing/__pycache__', 'micomputing/test.py', 'micomputing/README.md', 'micomputing/funcs.py', 'micomputing/micfuncions.cpp', 'micomputing/zxhtools', 'micomputing/network.py', 'micomputing/trans.py', 'micomputing/micfunctions.so', 'micomputing/stdio.py', 'micomputing/data.py']
)
