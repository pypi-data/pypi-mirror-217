...
class TestCompletionsAddSqueeze:
    def test_add_squeeze(self, completions_set, delete_workflow, unsupported_version_2019):
    ...
    def test_add_squeeze_empty_name(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_add_squeeze_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        with pytest.raises(Exception) as exceptionInfo:
    ...
    def test_add_two_squeezes_with_same_info_is_allowed(self, completions_set, delete_workflow, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        ...
        assert type(completions_set.squeezes["Duplicate Squeeze"][0]) is Squeeze
        assert completions_set.squeezes["Duplicate Squeeze"][0].bottom_md == 9870.55
        assert type(completions_set.squeezes["Duplicate Squeeze"][1]) is Squeeze
