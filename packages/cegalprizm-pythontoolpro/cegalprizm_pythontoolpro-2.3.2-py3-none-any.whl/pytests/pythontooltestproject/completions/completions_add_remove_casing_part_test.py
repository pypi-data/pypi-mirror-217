...
class TestCompletionsAddRemoveCasingParts:
    def test_add_and_remove_casing_part(self, completions_set, unsupported_version_2019):
    ...
    def test_add_casing_part_equipment_incorrect_type(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        ...
        assert "1234.56 has type float, but expected one of: bytes, unicode" in exceptionInfo.value.args[0]

    def test_add_casing_part_negative_depth(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
    ...
    def test_add_casing_part_zero_depth(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        with pytest.raises(ValueError) as exceptionInfo:
    ...
    def test_add_casing_part_depth_too_shallow(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
    ...
    def test_add_casing_part_depth_exactly_top_depth(self, completions_set, unsupported_version_2019):
        ...
        assert type(top_part_before) is CasingStringPart
        ...
        assert type(top_part_after) is CasingStringPart
        ...
        assert type(top_part_finally) is CasingStringPart
        assert top_part_finally.bottom_md == 1574.44

    def test_add_casing_part_depth_exactly_bottom_depth(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        with pytest.raises(UserErrorException) as exceptionInfo:
    ...
    def test_add_casing_part_depth_exactly_on_split(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
    ...
    def test_add_casing_part_depth_too_deep(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        with pytest.raises(UserErrorException) as exceptionInfo:
    ...
    def test_add_casing_part_depth_incorrect_type(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        with pytest.raises(TypeError) as exceptionInfo:
    ...
    def test_remove_already_existing_casing_part(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
    ...
    def test_remove_same_part_twice(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        part2 = casing.parts["Casing 1:2"]
    ...
    def test_remove_last_part(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        casing = completions_set.casings["Casing 1"]
        part2 = casing.parts["Casing 1:2"]
    ...
    # def test_use_add_remove_to_change_part_equipment(self, completions_set, unsupported_version_2019):
    #     if unsupported_version_2019 == True:
    #         pytest.skip("Unsupported Petrel version: 2019")
    #     casing = completions_set.casings["Casing 1"]
