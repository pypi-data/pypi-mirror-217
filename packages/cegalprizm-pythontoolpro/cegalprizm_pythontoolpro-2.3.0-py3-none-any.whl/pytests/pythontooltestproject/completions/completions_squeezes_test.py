...
class TestCompletionsSqueezes:
    def test_squeeze_get_by_name(self, completions_set, unsupported_version_2019):
    ...
    def test_squeeze_get_by_name_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        no_squeeze = completions_set.squeezes["NothingToSeeHere"]
        assert no_squeeze is None

    def test_squeeze_get_by_index(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_squeeze_get_by_index_out_of_range(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_squeeze_get_by_index_negative(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_squeeze_get_by_index_bad_type(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        assert completions_set.squeezes[1.56] is None

    def test_squeeze_get_none(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        assert completions_set.squeezes[None] is None

    def test_squeeze_iterator(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_squeeze_print_repr(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 1"]
    ...
    def test_squeeze_get_set_top_md(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 1"]
        old_depth = 8800
    ...
    def test_squeeze_set_top_md_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 1"]
    ...
    def test_squeeze_get_set_bottom_md(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 1"]
        old_depth = 8850
    ...
    def test_squeeze_set_bottom_md_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 1"]
        with pytest.raises(TypeError):
    ...
    def test_squeeze_get_set_date(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_squeeze_set_date_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 2"]
    ...
    def test_squeeze_template(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        squeeze = completions_set.squeezes["Squeeze 2"]
