...
class TestCompletionsPlugbacks:
    def test_plugback_get_by_name(self, completions_set, unsupported_version_2019):
    ...
    def test_plugback_get_by_name_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        no_plugback = completions_set.plugbacks["NothingToSeeHere"]
        assert no_plugback is None

    def test_plugback_get_by_index(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_plugback_get_by_index_out_of_range(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_plugback_get_by_index_negative(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_plugback_get_by_index_bad_type(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        assert completions_set.plugbacks[1.56] is None

    def test_plugback_get_none(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        assert completions_set.plugbacks[None] is None

    def test_plugback_iterator(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
    ...
    def test_plugback_print_repr(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
    ...
    def test_plugback_get_set_top_md(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
        old_depth = 9500
    ...
    def test_plugback_set_top_md_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
    ...
    def test_plugback_get_bottom_md(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
        assert plug.bottom_md == 10000

    def test_plugback_get_set_date(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        import datetime
        plug = completions_set.plugbacks["Plugback 1"]
    ...
    def test_plugback_set_date_bad_input(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
    ...
    def test_plugback_template(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        plug = completions_set.plugbacks["Plugback 1"]
