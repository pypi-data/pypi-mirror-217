...
class TestCompletionsAddCasing:
    def test_add_casing_all_data_ok(self, completions_set, delete_workflow, unsupported_version_2019):
    ...
    def test_add_casing_empty_date(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        name = "20in Casing"
        depth = 3030.55
    ...
    def test_add_casing_empty_name(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        date = datetime.datetime(1975,1,2)
        name = ""
    ...
    def test_add_casing_zero_depth(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        date = datetime.datetime(1975,1,2)
    ...
    def test_add_casing_bad_equipment_name(self, completions_set, unsupported_version_2019):
        if unsupported_version_2019 == True:
            pytest.skip("Unsupported Petrel version: 2019")
        date = datetime.datetime(1975,1,2)
