...
class TestPointSetDataFrame:
    ...
    def test_pointset_dataframe_dtypes(self, pointset_many):
        ...
        assert df.dtypes[5] == "datetime64[ns]"
        assert df.dtypes[6] == "float64"
        assert df.dtypes[7] == "float64"
        assert df.dtypes[8] == "float64"
        assert df.dtypes[9] == "float64"
        assert df.dtypes[10] == "float64"
        assert df.dtypes[11] == "bool"
        assert df.dtypes[12] == "Int64"
        assert df.dtypes[13] == "Int64"
        assert df.dtypes[14] == "object"
        assert df.dtypes[15] == "object"
