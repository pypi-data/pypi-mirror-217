...
class ETHKilnStatsGrossApy(BaseModel):
    """
    ETHKilnStatsGrossApy
    """
    last_1d: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Kiln's average APR from yesterday")
    last_7d: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Kiln's average APR from the last 7 days")
    last_30d: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Kiln's average APR from the last 30 days")
