...
class ETHPostKeysPayload(BaseModel):
    ...
    number: Union[confloat(le=150, ge=1, strict=True), conint(le=150, ge=1, strict=True)] = Field(..., description="Number of validator keys to generate. You can generate up to 150 keys at once.")
