...
class XTZNetworkStats(BaseModel):
    ...
    supply_staked_percent: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Supply percentage of Tezos currently staked")
    updated_at: Optional[datetime] = Field(None, description="Last date this data was updated")
    xtz_price_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="XTZ price in USD")
