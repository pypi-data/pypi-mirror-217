...
class ETHNetworkStats(BaseModel):
    ...
    supply_staked_percent: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Supply of Ethereum currently staked")
    eth_price_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Price of Ethereum in USD")
    estimated_entry_time_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Estimated queue entry time in seconds from a deposit to an active stake")
    estimated_exit_time_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Estimated queue exit time in seconds from an exit request to an exited stake")
    estimated_withdrawal_time_seconds: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Estimated time for a stake to receive Consensus rewards on the execution layer")
