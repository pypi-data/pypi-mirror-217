...
class ETHStake(BaseModel):
    ...
    gross_apy: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Gross annual percentage yield")
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.activated_epoch is None and "activated_epoch" in self.__fields_set__:
            _dict['activated_epoch'] = None

        # set to None if delegated_at (nullable) is None
        # and __fields_set__ contains the field
        if self.delegated_at is None and "delegated_at" in self.__fields_set__:
            _dict['delegated_at'] = None

        # set to None if delegated_block (nullable) is None
        # and __fields_set__ contains the field
        if self.delegated_block is None and "delegated_block" in self.__fields_set__:
            _dict['delegated_block'] = None

        # set to None if deposit_tx_sender (nullable) is None
        # and __fields_set__ contains the field
        if self.deposit_tx_sender is None and "deposit_tx_sender" in self.__fields_set__:
            _dict['deposit_tx_sender'] = None

        # set to None if execution_fee_recipient (nullable) is None
        # and __fields_set__ contains the field
        if self.execution_fee_recipient is None and "execution_fee_recipient" in self.__fields_set__:
            _dict['execution_fee_recipient'] = None

        # set to None if withdrawal_credentials (nullable) is None
        # and __fields_set__ contains the field
        if self.withdrawal_credentials is None and "withdrawal_credentials" in self.__fields_set__:
            _dict['withdrawal_credentials'] = None

        # set to None if effective_balance (nullable) is None
        # and __fields_set__ contains the field
        if self.effective_balance is None and "effective_balance" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.consensus_rewards is None and "consensus_rewards" in self.__fields_set__:
            _dict['consensus_rewards'] = None

        # set to None if execution_rewards (nullable) is None
        # and __fields_set__ contains the field
        if self.execution_rewards is None and "execution_rewards" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.gross_apy is None and "gross_apy" in self.__fields_set__:
            _dict['gross_apy'] = None

        # set to None if is_kiln (nullable) is None
        # and __fields_set__ contains the field
        if self.is_kiln is None and "is_kiln" in self.__fields_set__:
            _dict['is_kiln'] = None
