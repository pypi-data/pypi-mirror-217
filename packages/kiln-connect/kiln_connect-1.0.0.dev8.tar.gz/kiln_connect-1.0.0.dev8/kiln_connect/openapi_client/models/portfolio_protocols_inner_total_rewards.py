...
class PortfolioProtocolsInnerTotalRewards(BaseModel):
    """
    PortfolioProtocolsInnerTotalRewards
    """
    amount_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total USD of rewards earned for this protocol")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total rewards earned in the native protocol token for this protocol")
