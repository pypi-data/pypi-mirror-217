...
class GetSolRewards200ResponseDataInner(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetSolRewards200ResponseDataInner with anyOf schemas: SOLRewardByDay, SOLRewardByEpoch. Details: " + ", ".join(error_messages))
        else:
            return v
