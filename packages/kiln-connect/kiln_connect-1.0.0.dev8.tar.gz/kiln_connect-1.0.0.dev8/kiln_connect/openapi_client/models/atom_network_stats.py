...
class ATOMNetworkStats(BaseModel):
    ...
    ATOMNetworkStats
    """
    nb_validators: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Number of validators in the network")
    network_gross_apy: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Gross annual percentage yield")
    supply_staked_percent: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Supply of ATOM currently staked")
    atom_price_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Price of ATOM in USD")
