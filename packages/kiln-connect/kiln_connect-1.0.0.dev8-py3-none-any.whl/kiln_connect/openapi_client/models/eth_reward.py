...
class ETHReward(BaseModel):
    ...
    cl_apy: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Consensus annual percentage yield")
    el_apy: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Execution annual percentage yield")
