...
class SOLStake(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.withdraw_pubkey is None and "withdraw_pubkey" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.deactivated_epoch is None and "deactivated_epoch" in self.__fields_set__:
