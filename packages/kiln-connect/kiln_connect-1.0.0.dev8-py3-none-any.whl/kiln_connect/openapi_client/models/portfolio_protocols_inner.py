...
class PortfolioProtocolsInner(BaseModel):
    ...
    balance_share_percent: Optional[Union[confloat(le=100, ge=0, strict=True), conint(le=100, ge=0, strict=True)]] = Field(None, description="Protocol share of the total balance")
    rewards_share_percent: Optional[Union[confloat(le=100, ge=0, strict=True), conint(le=100, ge=0, strict=True)]] = Field(None, description="Protocol share of the total rewards earned")
