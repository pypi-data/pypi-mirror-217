...
class GetXtzOperations200ResponseDataInner(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetXtzOperations200ResponseDataInner with anyOf schemas: XTZOperationActivation, XTZOperationDelegate, XTZOperationPayment, XTZOperationUndelegate. Details: " + ", ".join(error_messages))
        else:
            return v
