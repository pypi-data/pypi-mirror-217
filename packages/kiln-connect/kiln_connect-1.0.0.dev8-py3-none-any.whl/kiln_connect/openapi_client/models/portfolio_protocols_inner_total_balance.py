...
class PortfolioProtocolsInnerTotalBalance(BaseModel):
    """
    PortfolioProtocolsInnerTotalBalance
    """
    amount_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total USD balance of stakes for this protocol")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total balance of stakes in the native protocol token for this protocol")
