...
class ETHPostKeysCliResponseInner(BaseModel):
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Amount in GWEI that needs to be deposited to activate the validator")
