...
class GetXtzRewards200ResponseDataInner(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetXtzRewards200ResponseDataInner with anyOf schemas: XTZCycleReward, XTZDailyReward. Details: " + ", ".join(error_messages))
        else:
            return v
