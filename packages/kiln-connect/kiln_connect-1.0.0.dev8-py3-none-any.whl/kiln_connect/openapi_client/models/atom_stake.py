...
class ATOMStake(BaseModel):
    ...
    net_apy: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Net annual percentage yield")
    state: Optional[StrictStr] = Field(None, description="State of the Atom stake")
    updated_at: Optional[datetime] = Field(None, description="Last date this data was updated")
    __properties = ["validator_address", "delegator_address", "delegated_at", "undelegated_at", "rewards", "available_rewards", "balance", "net_apy", "state", "updated_at"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.undelegated_at is None and "undelegated_at" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.available_rewards is None and "available_rewards" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.net_apy is None and "net_apy" in self.__fields_set__:
            _dict['net_apy'] = None
