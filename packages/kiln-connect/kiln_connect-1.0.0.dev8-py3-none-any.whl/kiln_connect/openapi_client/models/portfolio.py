...
class Portfolio(BaseModel):
    ...
    Portfolio
    """
    total_balance_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total USD balance of all the account's stakes")
    total_rewards_usd: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Total USD of rewards earned from all the account's stakes")
