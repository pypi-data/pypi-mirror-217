...
class SOLPostStakesPayloadStakesInner(BaseModel):
    """
    SOLPostStakesPayloadStakesInner
    """
    stake_account: Optional[StrictStr] = Field(None, alias="stakeAccount", description="Stake account to be delegated")
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Balance to delegate in SOL")
    ...
    def to_dict(self):
        ...
        if self.stake_account is None and "stake_account" in self.__fields_set__:
