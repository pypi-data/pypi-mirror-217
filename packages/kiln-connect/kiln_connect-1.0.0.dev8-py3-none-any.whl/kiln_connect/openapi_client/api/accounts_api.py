...
class AccountsApi(object):
    ...
    def delete_account(self, id : Annotated[StrictStr, Field(..., description="Account id")], **kwargs) -> PostAccount201Response:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_account_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Account id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Account  # noqa: E501
    ...
    @validate_arguments
    def get_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Account id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Account  # noqa: E501
    ...
    def get_account_portfolio(self, id : Annotated[StrictStr, Field(..., description="Account id")], **kwargs) -> GetAccountPortfolio200Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_account_portfolio_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_account_portfolio_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_account_portfolio_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Account id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Account Portfolio  # noqa: E501
    ...
    def post_account(self, account_payload : Annotated[AccountPayload, Field(..., description="Account to create")], **kwargs) -> PostAccount201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the post_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.post_account_with_http_info(account_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def post_account_with_http_info(self, account_payload : Annotated[AccountPayload, Field(..., description="Account to create")], **kwargs) -> ApiResponse:  # noqa: E501
        """Accounts  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['account_payload'] is not None:
    ...
    def put_account(self, id : Annotated[StrictStr, Field(..., description="Account id")], account_payload : Annotated[AccountPayload, Field(..., description="Account to update")], **kwargs) -> PostAccount201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the put_account_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.put_account_with_http_info(id, account_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def put_account_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Account id")], account_payload : Annotated[AccountPayload, Field(..., description="Account to update")], **kwargs) -> ApiResponse:  # noqa: E501
        """Account  # noqa: E501
