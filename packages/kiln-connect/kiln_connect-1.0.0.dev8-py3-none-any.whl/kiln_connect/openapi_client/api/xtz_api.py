...
class XtzApi(object):
    ...
    def get_xtz_network_stats(self, **kwargs) -> GetXtzNetworkStats200Response:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_network_stats_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_xtz_network_stats_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_xtz_network_stats_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Network Stats  # noqa: E501
    ...
    def get_xtz_operations(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> GetXtzOperations200Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_operations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_xtz_operations_with_http_info(wallets, accounts, **kwargs)  # noqa: E501

    @validate_arguments
    def get_xtz_operations_with_http_info(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Operations  # noqa: E501
    ...
    def get_xtz_reports(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> bytearray:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_reports_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_xtz_reports_with_http_info(wallets, accounts, **kwargs)  # noqa: E501

    @validate_arguments
    def get_xtz_reports_with_http_info(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Excel Reports  # noqa: E501
    ...
    def get_xtz_rewards(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, format : Annotated[Optional[StrictStr], Field(description="The format of the response. Defaults to daily")] = None, start_date : Annotated[Optional[date], Field(description="Get rewards from this date (YYYY-MM-DD)")] = None, end_date : Annotated[Optional[date], Field(description="Get rewards to this date (YYYY-MM-DD)")] = None, start_cycle : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The cycle from which we want to fetch rewards. Must be used with format=cycle")] = None, end_cycle : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="The cycle until which we want to fetch rewards. Must be used with format=cycle")] = None, **kwargs) -> GetXtzRewards200Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_rewards_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def get_xtz_stakes(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> GetXtzStakes200Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_stakes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_xtz_stakes_with_http_info(wallets, accounts, **kwargs)  # noqa: E501

    @validate_arguments
    def get_xtz_stakes_with_http_info(self, wallets : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of wallets addresses")] = None, accounts : Annotated[Optional[conlist(StrictStr)], Field(description="Comma-separated list of Kiln accounts identifiers")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Stakes  # noqa: E501
    ...
    def get_xtz_tx_status(self, tx_hash : Annotated[StrictStr, Field(..., description="Hash of the transaction")], block_number : Annotated[StrictStr, Field(..., description="Block number in which the transaction was included")], **kwargs) -> GetXtzTxStatus200Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_xtz_tx_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_xtz_tx_status_with_http_info(tx_hash, block_number, **kwargs)  # noqa: E501

    @validate_arguments
    def get_xtz_tx_status_with_http_info(self, tx_hash : Annotated[StrictStr, Field(..., description="Hash of the transaction")], block_number : Annotated[StrictStr, Field(..., description="Block number in which the transaction was included")], **kwargs) -> ApiResponse:  # noqa: E501
        """Transaction Status  # noqa: E501
    ...
    def post_xtz_broadcast_tx(self, xtz_broadcast_tx_payload : Annotated[XTZBroadcastTxPayload, Field(..., description="Transaction to broadcast")], **kwargs) -> PostXtzBroadcastTx201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the post_xtz_broadcast_tx_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.post_xtz_broadcast_tx_with_http_info(xtz_broadcast_tx_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def post_xtz_broadcast_tx_with_http_info(self, xtz_broadcast_tx_payload : Annotated[XTZBroadcastTxPayload, Field(..., description="Transaction to broadcast")], **kwargs) -> ApiResponse:  # noqa: E501
        """Broadcast Transaction  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['xtz_broadcast_tx_payload'] is not None:
    ...
    def post_xtz_prepare_tx(self, xtz_prepare_tx_payload : Annotated[XTZPrepareTxPayload, Field(..., description="Transaction to prepare")], **kwargs) -> PostXtzPrepareTx201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the post_xtz_prepare_tx_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.post_xtz_prepare_tx_with_http_info(xtz_prepare_tx_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def post_xtz_prepare_tx_with_http_info(self, xtz_prepare_tx_payload : Annotated[XTZPrepareTxPayload, Field(..., description="Transaction to prepare")], **kwargs) -> ApiResponse:  # noqa: E501
        """Prepare Transaction  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['xtz_prepare_tx_payload'] is not None:
    ...
    def post_xtz_stake_tx(self, xtz_craft_stake_tx_payload : Annotated[XTZCraftStakeTxPayload, Field(..., description="Transaction to craft")], **kwargs) -> PostXtzStakeTx201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the post_xtz_stake_tx_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.post_xtz_stake_tx_with_http_info(xtz_craft_stake_tx_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def post_xtz_stake_tx_with_http_info(self, xtz_craft_stake_tx_payload : Annotated[XTZCraftStakeTxPayload, Field(..., description="Transaction to craft")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stake Transaction  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['xtz_craft_stake_tx_payload'] is not None:
    ...
    def post_xtz_un_stake_tx(self, xtz_craft_un_stake_tx_payload : Annotated[XTZCraftUnStakeTxPayload, Field(..., description="Transaction to craft")], **kwargs) -> PostXtzStakeTx201Response:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the post_xtz_un_stake_tx_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.post_xtz_un_stake_tx_with_http_info(xtz_craft_un_stake_tx_payload, **kwargs)  # noqa: E501

    @validate_arguments
    def post_xtz_un_stake_tx_with_http_info(self, xtz_craft_un_stake_tx_payload : Annotated[XTZCraftUnStakeTxPayload, Field(..., description="Transaction to craft")], **kwargs) -> ApiResponse:  # noqa: E501
        """Unstake Transaction  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['xtz_craft_un_stake_tx_payload'] is not None:
