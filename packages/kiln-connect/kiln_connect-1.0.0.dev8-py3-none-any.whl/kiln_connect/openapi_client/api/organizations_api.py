...
class OrganizationsApi(object):
    ...
    def get_organization_portfolio(self, id : Annotated[StrictStr, Field(..., description="Organization id")], **kwargs) -> GetAccountPortfolio200Response:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_organization_portfolio_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_organization_portfolio_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_organization_portfolio_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Organization id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Organization Portfolio  # noqa: E501
