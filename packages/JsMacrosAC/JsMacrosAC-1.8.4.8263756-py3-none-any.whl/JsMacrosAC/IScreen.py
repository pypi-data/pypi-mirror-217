...
class IScreen(IDraw2D):
	...
	@overload
	def addTexturedButton(self, x: int, y: int, width: int, height: int, textureStartX: int, textureStartY: int, hoverOffset: int, texture: str, textureWidth: int, textureHeight: int, callback: MethodWrapper) -> ButtonWidgetHelper:
		"""
		Since: 1.8.4 

		Args:
			textureStartX: the x position in the texture to start drawing from 
			texture: the identifier of the texture to use 
			textureWidth: the width of the texture 
			textureStartY: the y position in the texture to start drawing from 
			x: the x position of the textured button 
			width: the width of the textured button 
			y: the y position of the textured button 
			callback: calls your method as a Consumer ButtonWidgetHelper 
			hoverOffset: the offset to add to the textureStartY when the button is hovered 
			textureHeight: the height of the texture 
			height: the height of the textured button 

		Returns:
			a ButtonWidgetHelper for the given input. 
		"""
		pass

	@overload
	def addTexturedButton(self, x: int, y: int, width: int, height: int, zIndex: int, textureStartX: int, textureStartY: int, hoverOffset: int, texture: str, textureWidth: int, textureHeight: int, callback: MethodWrapper) -> ButtonWidgetHelper:
		"""
		Since: 1.8.4 
		...
		Args:
			...
			textureHeight: the height of the texture 
			height: the height of the textured button 
			zIndex: the z-index of the textured button 
	...
	@overload
	def addTexturedButton(self, x: int, y: int, width: int, height: int, textureStartX: int, textureStartY: int, texture: str, callback: MethodWrapper) -> ButtonWidgetHelper:
		"""
		Since: 1.8.4 
	...
	@overload
	def addTexturedButton(self, x: int, y: int, width: int, height: int, zIndex: int, textureStartX: int, textureStartY: int, texture: str, callback: MethodWrapper) -> ButtonWidgetHelper:
		"""
		Since: 1.8.4 
	...
	def addCyclingButton(self, x: int, y: int, width: int, height: int, values: List[str], initial: str, callback: MethodWrapper) -> CyclingButtonWidgetHelper:
		...
		Args:
			...
			x: the x position of the cylcing button 
			width: the width of the cylcing button 
			y: the y position of the cylcing button 
