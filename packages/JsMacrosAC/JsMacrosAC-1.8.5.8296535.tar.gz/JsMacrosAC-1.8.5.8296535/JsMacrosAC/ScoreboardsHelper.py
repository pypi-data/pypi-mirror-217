...
team. 
	...
	def getTeamColor(self, player: PlayerEntityHelper) -> int:
		...
		Returns:
			the color of the speicifed player's team or '-1' if the player is not in a team. 
		"""
		pass
	...
	def getTeamColorName(self, player: PlayerEntityHelper) -> str:
		...
		Returns:
			the name of the speicifed player's team color or 'null' if the player is not in
a team. 
		"""
		pass
