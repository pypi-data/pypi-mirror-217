...
class StartAutonacRun(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hardware", "n_machines_always_up", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hardware", "n_machines_always_up", "name", ], str]):
