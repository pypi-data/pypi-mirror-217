...
@overload
def sleep(*thresholds: int, precision: None = None) -> int: ...

@overload
def sleep(*thresholds: float, precision: None = None) -> float: ...

@overload
def sleep(*thresholds: Union[int, float], precision: Literal[0] = None) -> int: ...

@overload
def sleep(*thresholds: Union[int, float], precision: int = None) -> float: ...
