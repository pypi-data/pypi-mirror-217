...
# --------------------------------------------------------
# Generated by AdaoCatalogGenerator on 2023-06-06 18:31:58
# --------------------------------------------------------
...
def F_AlgorithmParameters(statut, algos_names, fv=NoCheckInNS) : return FACT(
    ...
    ParametersParticleSwarmOptimization = BLOC (condition = " (Parameters == 'Defaults') and (Algorithm == 'ParticleSwarmOptimization') ",
        ...
        Variant = SIMP(statut="f", typ="TXM", min=1, max=1, defaut="CanonicalPSO", into=['CanonicalPSO', 'OGCR', 'SPSO-2011'], fr="Variant ou formulation de la méthode"),
