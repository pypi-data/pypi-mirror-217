...
def AddEllipsoid(builder, ellipsoid): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(ellipsoid), 0)
def GeodeticCoordinatesAddEllipsoid(builder, ellipsoid):
    """This method is deprecated. Please switch to AddEllipsoid."""
    return AddEllipsoid(builder, ellipsoid)
def AddLongitude(builder, longitude): builder.PrependFloat64Slot(2, longitude, 0.0)
...
def AddLatitude(builder, latitude): builder.PrependFloat64Slot(3, latitude, 0.0)
...
def AddAltitude(builder, altitude): builder.PrependFloat64Slot(4, altitude, 0.0)
