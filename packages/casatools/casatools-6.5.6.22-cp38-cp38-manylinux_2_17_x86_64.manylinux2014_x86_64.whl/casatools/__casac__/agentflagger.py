...
class agentflagger(object):
    ...
    def parsequackparameters(self, *args, **kwargs):
        r"""
        parsequackparameters(self, _field=string(""), _spw=string(""), _array=string(""), _feed=string(""), _scan=string(""), _antenna=string(""), _uvrange=string(""), _time=string(""), _correlation=string(""), _intent=string(""), _observation=string(""), _quackmode=string("beg"), _quackinterval=double(0.0), _quackincrement=bool(false), _apply=bool(true)) -> bool
