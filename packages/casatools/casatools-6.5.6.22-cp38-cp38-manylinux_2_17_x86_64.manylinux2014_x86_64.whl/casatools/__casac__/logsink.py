...
class logsink(object):
    ...
    def __init__(self, *args, **kwargs):
        r"""__init__(self, _filename=string("casa.log"), _enable_telemetry=bool(false), _telemetry_logfile=string("false")) -> logsink"""
    ...
    def poststat(self, *args, **kwargs):
        r"""
        poststat(self, _message=string(""), _origin=string("")) -> bool
    ...
    def setstatslogfile(self, *args, **kwargs):
        r"""
        setstatslogfile(self, _filename=string("casapy.log")) -> bool
