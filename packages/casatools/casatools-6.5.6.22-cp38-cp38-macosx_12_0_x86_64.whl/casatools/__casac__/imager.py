...
class imager(object):
    ...
    def setsdoptions(self, *args, **kwargs):
        r"""
        setsdoptions(self, _scale=double(1.0), _weight=double(1.0), _convsupport=long(-1), _pointingcolumntouse=string("DIRECTION"), _truncate=variant( ), _gwidth=variant( ), _jwidth=variant( ), _minweight=double(0.), _clipminmax=bool(false), _enablecache=bool(false)) -> bool
