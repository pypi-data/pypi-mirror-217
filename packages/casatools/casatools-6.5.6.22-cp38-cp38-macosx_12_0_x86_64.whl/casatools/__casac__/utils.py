...
class utils(object):
    ...
    def _crash_reporter_initialize(self, *args, **kwargs):
        r"""
        _crash_reporter_initialize(self, _crashDumpDirectory=string(""), _crashDumpPosterApplication=string(""), _crashPostingUrl=string(""), _logFile=string("")) -> string
