...
class Asset(object):
    ...
    Attributes:
        ...
        special_hint (int): TODO: type description here.
    ...
    def __init__(self,
        ...
        if special_hint is not APIHelper.SKIP:
            self.special_hint = special_hint 
    ...
    def from_dictionary(cls,
        ...
        special_hint = dictionary.get("special_hint_") if dictionary.get("special_hint_") else APIHelper.SKIP
