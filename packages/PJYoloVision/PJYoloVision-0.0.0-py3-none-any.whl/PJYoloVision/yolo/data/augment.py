...
class Albumentations:
    # PJYoloVision Albumentations class (optional, only used if package is installed)
...
class ClassifyLetterBox:
    # PJYoloVision LetterBox class for image preprocessing, i.e. T.Compose([LetterBox(size), ToTensor()])
...
class CenterCrop:
    # PJYoloVision CenterCrop class for image preprocessing, i.e. T.Compose([CenterCrop(size), ToTensor()])
...
class ToTensor:
    # PJYoloVision ToTensor class for image preprocessing, i.e. T.Compose([LetterBox(size), ToTensor()])
