...
class Company(CamelModel):
    ...
    company_href: str = Field(
        ..., description="Full webpage link", example="http://delphai.com"
    )
...
class ProjectsCompany(CamelModel):
    ...
    disabled: bool = Field(description="If the company is available on delphai")


class ProjectsCompanies(CamelModel):
    companies: List[ProjectsCompany]
