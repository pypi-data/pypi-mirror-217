...
def go(config: DictConfig):
    ...
    _ = mlflow.run(
        ...
        "run_mlflow",
        parameters={
            "site_id": config["data"]["site_res"],
            "date" : config["data"]["start_date"],
    ...
    _ = mlflow.run(
        os.path.join(root_path, "mlflow_pipelines/upload_data"),
        "run_mlflow",
        parameters={
    ...
    _ = mlflow.run(
        os.path.join(root_path, "mlflow_pipelines/train_model"),
        "run_mlflow",
        parameters={
