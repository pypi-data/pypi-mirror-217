...
PACKAGE_NAME = 'SendSingleW10' #Debe coincidir con el nombre de la carpeta 
...
DESCRIPTION = 'Librería para Enviar data a un servidor en base a Librerias de Windows 10' #Descripción corta
