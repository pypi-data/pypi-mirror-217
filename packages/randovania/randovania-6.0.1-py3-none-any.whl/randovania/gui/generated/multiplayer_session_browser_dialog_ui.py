...
class Ui_MultiplayerSessionBrowserDialog(object):
    def setupUi(self, MultiplayerSessionBrowserDialog):
        ...
        MultiplayerSessionBrowserDialog.resize(694, 455)
        ...
        self.table_widget = QTableWidget(MultiplayerSessionBrowserDialog)
    ...
    def retranslateUi(self, MultiplayerSessionBrowserDialog):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Name", None));
        ___qtablewidgetitem1 = self.table_widget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"State", None));
        ___qtablewidgetitem2 = self.table_widget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Players", None));
        ___qtablewidgetitem3 = self.table_widget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Password?", None));
        ___qtablewidgetitem4 = self.table_widget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Creator", None));
        ___qtablewidgetitem5 = self.table_widget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Creation Date", None));
        ...
        self.state_inprogress_check.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"In-Progress", None))
        self.has_password_no_check.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"No", None))
        self.state_filter_label.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"State:", None))
        self.state_finished_check.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Finished", None))
        self.state_setup_check.setText(QCoreApplication.translate("MultiplayerSessionBrowserDialog", u"Setup", None))
