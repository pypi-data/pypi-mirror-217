...
class Ui_PresetPrimeQol(object):
    def setupUi(self, PresetPrimeQol):
        ...
        self.scroll_contents.setGeometry(QRect(0, -253, 487, 956))
    ...
    def retranslateUi(self, PresetPrimeQol):
        ...
        self.cutscene_group.setTitle(QCoreApplication.translate("PresetPrimeQol", u"Cutscene removal mode", None))
